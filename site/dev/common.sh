...
scan_markdown_files () {
  ...
  pymarkdown --config markdownlint.yml scan docs/docs/nightly/docs/*.md docs/*.md README.md
}

fix_markdown_files () {
  echo " --> fix markdown file styles"
  pymarkdown --config markdownlint.yml fix docs/docs/nightly/docs/*.md docs/*.md README.md
}
