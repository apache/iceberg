...
* Core
    ...
    - Support timestamp(9) and unknown types ([\#12455](https://github.com/apache/iceberg/pull/12455))
...
* Parquet
    ...
    - Support unknown and timestamp(9) in internal model and generics ([\#12463](https://github.com/apache/iceberg/pull/12463))
