...
| commit.retry.total-timeout-ms      | 1800000 (30 min) | Totals retry timeout period in milliseconds for a commit |
...
| commit.status-check.total-timeout-ms| 1800000 (30 min) | Totals status-check timeout period in milliseconds |
