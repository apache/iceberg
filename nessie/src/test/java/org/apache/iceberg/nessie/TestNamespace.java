...
public class TestNamespace extends BaseTestIceberg {
  ...
  public void testListNamespaces() {
    createTable(TableIdentifier.of("a.b.c.t1"));
    createTable(TableIdentifier.of("a.b.t2"));
    createTable(TableIdentifier.of("a.t3"));
    createTable(TableIdentifier.of("b.c.t4"));
    createTable(TableIdentifier.of("b.t5"));
