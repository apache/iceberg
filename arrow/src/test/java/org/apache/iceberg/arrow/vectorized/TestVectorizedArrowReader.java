...
public class TestVectorizedArrowReader {
  ...
  @Test
  public void testPositionReaderWithSequentialRowsAcrossBatches() {
  ...
  @Test
  public void testPositionReaderWithRowIndexesAcrossBatches() {
    VectorizedArrowReader reader = VectorizedArrowReader.positions();
    reader.setBatchSize(2);
  ...
  @Test
  public void testPositionReaderResetsForNewPageStore() {
    VectorizedArrowReader reader = VectorizedArrowReader.positions();
    reader.setBatchSize(2);
