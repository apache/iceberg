...
# Usage: dev/confluent-hub-package.sh [TAG]
...
CONNECT_RUNTIME_DIR="${PROJECT_ROOT}/kafka-connect/kafka-connect-runtime"
...
trap "rm -f '${PROJECT_ROOT}/version.txt'; cd '${ORIGINAL_DIR}'" EXIT
...
# Extract
DIST_DIR="${CONNECT_RUNTIME_DIR}/build/distributions"
...
WORK_DIR="${CONNECT_RUNTIME_DIR}/build/confluent-hub-work"
...
# Add logo
mkdir -p "${PKG}/assets"
cp "${CONNECT_RUNTIME_DIR}/src/main/resources/iceberg.png" "${PKG}/assets/"
