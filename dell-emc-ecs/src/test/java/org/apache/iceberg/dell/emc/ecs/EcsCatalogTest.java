...
public class EcsCatalogTest {
    ...
    public void init() {
        ...
        properties.put(EcsCatalogProperties.ECS_CLIENT_FACTORY, "org.apache.iceberg.dell.emc.ecs.MemoryEcsClient#create");
    ...
    public void listNamespaces() {
        ...
        assertEquals("namespaces in empty namespace",
                Collections.singletonList(namespaceL1),
                ecsCatalog.listNamespaces(Namespace.empty()));

        assertEquals("namespace in l1 namespace",
    ...
    public void dropNamespace() {
        ...
        assertTrue("no namespace in empty namespace",
