...
import org.apache.iceberg.dell.emc.ecs.utils.PositionOutputStreamAdapter;
...
public class EcsFile implements InputFile, OutputFile {
    ...
    public long getLength() {
        return ecs.head(key).orElseThrow(() -> new IllegalStateException(String.format("object not found %s", key))).getContentLength();
    }
