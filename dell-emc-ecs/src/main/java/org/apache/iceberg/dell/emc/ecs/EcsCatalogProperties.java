...
public interface EcsCatalogProperties {
     ...
     * <p>
     * The method should be static and use format like: "org.apache.iceberg.dell.emc.ecs.EcsClient#create"
     * <p>
    ...
    static Optional<EcsClient> getEcsClientFromFactory(Map<String, String> properties) {
        ...
        try {
            ...
            throw new IllegalArgumentException(String.format("invalid property %s that throw exception", ECS_CLIENT_FACTORY), e);
        }
        if (client == null) {
            throw new IllegalArgumentException(String.format("invalid property %s that return null client", ECS_CLIENT_FACTORY));
        }
