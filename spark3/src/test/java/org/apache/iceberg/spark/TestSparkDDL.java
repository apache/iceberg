...
public class TestSparkDDL extends SparkTestBase {
  private static final TableIdentifier IDENT = TableIdentifier.of("default", "table");
  private static File warehouse = null;

  @BeforeClass
  public static void createWarehouse() throws IOException {
    TestSparkDDL.warehouse = File.createTempFile("warehouse", null);
  ...
  public static Object[][] parameters() {
    return new Object[][] {
        new Object[] { "testhive", SparkCatalog.class.getName(), ImmutableMap.of("type", "hive") },
        new Object[] { "testhadoop", SparkCatalog.class.getName(), ImmutableMap.of("type", "hadoop") },
  ...
  private final Catalog validationCatalog;
  private final String fullTableName;

  public TestSparkDDL(String catalogName, String implementation, Map<String, String> config) {
    ...
    this.validationCatalog = catalogName.equals("testhadoop") ?
        ...
        catalog;
    this.fullTableName = (catalogName.equals("spark_catalog") ? "" : catalogName + ".") + "default.table";
  ...
  public void testCreateTable() {
    Assert.assertFalse("Table should not already exist", validationCatalog.tableExists(IDENT));

    sql("CREATE TABLE %s (id BIGINT NOT NULL, data STRING) USING iceberg", fullTableName);
  ...
  @Test
  public void testCreateTableUsing() {
    Assume.assumeTrue(
    ...
    sql("CREATE TABLE %s (id BIGINT NOT NULL, data STRING) USING parquet", fullTableName);
  ...
  public void testCreateTablePartitionedBy() {
    ...
    sql("CREATE TABLE %s " +
        ...
        "USING iceberg " +
        "PARTITIONED BY (category, bucket(8, id), days(created_at))", fullTableName);
