...
class OverwriteDynamicBatchWrite extends BaseBatchWrite {

  OverwriteDynamicBatchWrite(Table table, Broadcast<FileIO> io, Broadcast<EncryptionManager> encryptionManager,
