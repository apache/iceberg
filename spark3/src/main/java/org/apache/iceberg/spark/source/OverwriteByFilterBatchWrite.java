...
class OverwriteByFilterBatchWrite extends BaseBatchWrite {

  private final Expression overwriteExpr;

  OverwriteByFilterBatchWrite(Table table, Broadcast<FileIO> io, Broadcast<EncryptionManager> encryptionManager,
