...
public class TestIcebergInputFormat2 {
  ...
  public TestIcebergInputFormat2(String format) {
...
/*
  ...
  public void testIdentityPartitionProjections() throws Exception {
    ...
    for (Record record : inputRecords) {
      ...
      append.appendFile(writeFile(temp.newFile(), table, Row.of("2020-03-2" + idx, idx.toString()), format, ImmutableList.of(record)));
      idx += 1;
    }
    append.commit();
