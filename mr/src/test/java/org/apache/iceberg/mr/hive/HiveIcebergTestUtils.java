...
public class HiveIcebergTestUtils {
   ...
   */
  public static void validateFiles(Table table, String queryId, JobID jobId, int dataFileNum) throws IOException {
    ...
    Assert.assertFalse(new File(table.location() + "/" + queryId + "-" + jobId).exists());
  }
}
