...
abstract class IcebergPrimitiveObjectInspector implements PrimitiveObjectInspector {

  private final PrimitiveTypeInfo typeInfo;

  protected IcebergPrimitiveObjectInspector(PrimitiveTypeInfo typeInfo) {
