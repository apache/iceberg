...
public class HiveIcebergOutputCommitter extends OutputCommitter {
  ...
  public void commitTask(TaskAttemptContext ctx) throws IOException {
    TaskAttemptContext context = TezUtil.enrichContextWithAttemptWrapper(ctx);
   ...
   */
  @Override
  public void commitJob(JobContext jobCtx) throws IOException {
    JobContext jobContext = TezUtil.enrichContextWithVertexId(jobCtx);
   ...
   */
  @Override
  public void abortJob(JobContext jobCtx, int status) throws IOException {
    JobContext jobContext = TezUtil.enrichContextWithVertexId(jobCtx);
