...
public class TestIcebergWriterFactory {
  ...
  @Test
  void missingTableWithIgnoreFlagReturnsNoOpWriterAndTracksTable() {
    IcebergWriterFactory factory = newFactoryWithMissingTables();
  ...
  @Test
  void missingTableIsTrackedOnce() {
    IcebergWriterFactory factory = newFactoryWithMissingTables();
  ...
  @Test
  void noOpWriterIncrementsDroppedRecordCountPerWrite() {
    IcebergWriterFactory factory = newFactoryWithMissingTables();
    RecordWriter writer = factory.createWriter("db.missing", mock(SinkRecord.class), true);
  ...
  @Test
  void droppedRecordCountAccumulatesAcrossTables() {
    IcebergWriterFactory factory = newFactoryWithMissingTables();
  ...
  private static IcebergWriterFactory newFactoryWithMissingTables() {
    ...
    return new IcebergWriterFactory(catalog, config);
  }
}
