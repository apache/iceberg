...
public class TestCoordinator extends ChannelTestBase {
  ...
  public void testStaleGroupBlocksThenThrowsConnectException(int maxRetries) {
    ...
    // isGroupBlocking returns false and ConnectException is thrown — asserted below.
    int offset = 3;
  ...
  public void testMultiTablePartialCommitWithStaleExhaustion() {
    ...
    // isGroupBlocking returns false and ConnectException is thrown — asserted after the loop.
    int offset = 1;
    ...
    // (count > maxRetries), so isGroupBlocking returns false → throws ConnectException.
