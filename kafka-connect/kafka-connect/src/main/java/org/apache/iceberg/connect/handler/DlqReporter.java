...
public class DlqReporter implements AutoCloseable {
    ...
    public Properties initiateProperties(IcebergSinkConfig config) {
        ...
        producerProps.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, config.kafkaProps().get(CommonClientConfigs.BOOTSTRAP_SERVERS_CONFIG));
    ...
    public void send(String key, String value) {
        try {
            ...
            LOG.error(
                    "Error writing to dead letter queue topic: {}",
                    this.dlqTopic,
                    ex);
        }
    }
