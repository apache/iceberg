...
public abstract class ConnectTimeTypeToIntegerTypeTransform<R extends ConnectRecord<R>> implements Transformation<R> {
    ...
    private R applyWithSchema(R record) {
        final Struct value = requireStructOrNull(operatingValue(record), "Handling Iceberg Time Type");
    ...
    private void buildUpdatedSchema(Schema schema, SchemaBuilder newSchema, boolean optional, Struct defaultFromParent) {
        for (Field field : schema.fields()) {
            ...
            switch (fieldSchema.type()) {
                ...
                case ARRAY:
                    ...
                    buildUpdatedSchema(fieldSchema.valueSchema(), arrayBuilder, fieldIsOptional, (Struct) fieldDefaultValue);
                ...
                case MAP:
                    ...
                    buildUpdatedSchema(fieldSchema.valueSchema(), mapBuilder, fieldIsOptional, (Struct) fieldDefaultValue);
                ...
                case STRUCT:
                    ...
                    buildUpdatedSchema(fieldSchema, structBuilder, fieldIsOptional,
                            defaultFromParent != null ? (Struct) fieldDefaultValue : null);
                    fieldBuilder = structBuilder;
                    break;

                default:
                    throw new DataException("Schema transformation does not support type " + fieldSchema.type()
    ...
    public static class Value<R extends ConnectRecord<R>> extends ConnectTimeTypeToIntegerTypeTransform<R> {
        @Override
