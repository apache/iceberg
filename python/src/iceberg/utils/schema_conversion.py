...
class AvroSchemaConversion:
    def avro_to_iceberg(self, avro_schema: dict[str, Any]) -> Schema:
        ...
        Example:
            ...
            ...     ),
            ...     NestedField(
            ...         field_id=501, name="manifest_length", field_type=LongType(), required=True, doc="Total file size in bytes"
            ...     ),
            ...     schema_id=1
            ... )
    ...
    def _convert_array_type(self, array_type: dict[str, Any]) -> ListType:
        ...
        return ListType(
            ...
            element=self._convert_schema(plain_type),
            element_required=not element_is_optional,
        )
    ...
    def _convert_map_type(self, map_type: dict[str, Any]) -> MapType:
        ...
        return MapType(
            ...
            value_required=not value_is_optional,
        )
