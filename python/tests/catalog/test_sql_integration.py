...
#     identifier = (database_name, table_name)
#     test_catalog_no_warehouse = SQLCatalog("test_sql_catalog", uri="sqlite+pysqlite:///:memory:")
...
@pytest.mark.integration
def test_drop_table_that_does_not_exist(test_catalog: Catalog, table_name: str, database_name: str) -> None:
    identifier = (database_name, table_name)
    with pytest.raises(NoSuchTableError):
        test_catalog.drop_table(identifier)
