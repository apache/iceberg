...
public class TestDynamoDbV1SchemaCatalog extends TestDynamoDbCatalog {
    ...
    GetItemResponse response =
        dynamo.getItem(
            GetItemRequest.builder()
                ...
                .key(DynamoDbCatalog.namespacePrimaryKey(namespace, 1))
                .build());
    Assert.assertTrue("namespace must exist", response.hasItem());
    Assert.assertEquals(
        "namespace attribute must contain namespace in DynamoDB",
        namespace.toString(),
