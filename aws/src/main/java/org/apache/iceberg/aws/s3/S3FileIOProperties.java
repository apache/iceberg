...
public class S3FileIOProperties implements Serializable {
   ...
   * <p>For more details, see: https://github.com/awslabs/analytics-accelerator-s3
   */
  public static final String S3_ANALYTICS_ACCELERATOR_PREFIX = "s3.analytics-accelerator.";
  ...
  public S3FileIOProperties(Map<String, String> properties) {
    ...
    this.s3AnalyticsacceleratorProperties =
        PropertyUtil.propertiesWithPrefix(properties, S3_ANALYTICS_ACCELERATOR_PREFIX);
