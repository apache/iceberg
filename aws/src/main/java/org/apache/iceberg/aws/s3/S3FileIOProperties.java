...
public class S3FileIOProperties implements Serializable {
  ...
  public S3FileIOProperties() {
    ...
    this.s3AnalyticsacceleratorProperties =
        AnalyticsAcceleratorUtil.initAnalyticsAcceleratorProperties(
            Collections.emptyMap(), S3_FILE_IO_USER_AGENT);
    ...
    this.s3AnalyticsacceleratorProperties =
        AnalyticsAcceleratorUtil.initAnalyticsAcceleratorProperties(
            PropertyUtil.propertiesWithPrefix(
                properties, S3_ANALYTICS_ACCELERATOR_PROPERTIES_PREFIX),
  ...
  /**
   * Override the endpoint for S3 sync and async clients.
   *
   * <p>Sample usage:
   *
   * <pre>
