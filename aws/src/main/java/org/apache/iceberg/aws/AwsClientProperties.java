...
public class AwsClientProperties implements Serializable {
   ...
   *
   * <pre>
   *     S3AsyncClient.builder().applyMutation(awsClientProperties::applyAsyncConfigurations)
   * </pre>
   */
  public <T extends S3AsyncClientBuilder> void applyAsyncConfigurations(T builder) {
    builder.httpClientBuilder(
        NettyNioAsyncHttpClient.builder().maxConcurrency(clientMaxConcurrency));
  }
