  ...
  void authenticateWithoutBody() {
    ...
    try (RESTSigV4AuthSession session = new RESTSigV4AuthSession(signer, delegate, awsProperties)) {
      ...
      assertThat(actual.headers().entries())
          ...
          .satisfiesOnlyOnce(
              header -> {
                ...
                assertThat(header.value())
                    .contains(
                        "SignedHeaders=content-encoding;content-type;host;x-amz-checksum-sha256;x-amz-content-sha256;x-amz-date");
              })
          .satisfiesOnlyOnce(
              header -> {
          ...
          .satisfiesOnlyOnce(
              header -> {
                assertThat(header.name()).isEqualTo("x-amz-checksum-sha256");
                assertThat(header.value())
      ...
      assertThat(actual.headers().entries())
          ...
          .satisfiesOnlyOnce(
              header -> {
                assertThat(header.name()).isEqualTo("x-amz-content-sha256");
                assertThat(header.value())
                    .isEqualTo("c9ce6800a3d68c7638b16f1742ad25ff768daeb5c9281c9c5453670c418c7f0c");
              })
          .satisfiesOnlyOnce(header -> assertThat(header.name()).isEqualTo("X-Amz-Date"));
    }
  }
      ...
      assertThat(actual.headers().entries())
          ...
          .satisfiesOnlyOnce(
              header -> {
                ...
                assertThat(header.value())
                    .contains(
                        "SignedHeaders=content-type;host;original-authorization;x-amz-checksum-sha256;x-amz-content-sha256;x-amz-date");
              })
          // original header
          .satisfiesOnlyOnce(
              header -> {
      ...
      assertThat(actual.headers().entries())
          ...
          .satisfiesOnlyOnce(
              header -> {
                ...
                assertThat(header.value())
                    .contains(
                        "SignedHeaders=content-type;host;x-amz-checksum-sha256;x-amz-content-sha256;x-amz-date");
              })
          // original header
          .satisfiesOnlyOnce(
              header -> {
