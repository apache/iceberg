...
public class TestCosFileIO {
  ...
  public void testOutputFile() throws IOException {
    ...
    assertThat(data).as("Should have expected content").containsExactly(cosDataContent(uri, dataSize));
  }
  ...
  public void testInputFile() throws IOException {
    ...
    assertThat(data).as("Should have expected content").containsExactly(inFileContent(in, dataSize));
  }
  ...
  public void testLoadFileIO() {
    FileIO file = CatalogUtil.loadFileIO(COS_IMPL_CLASS, ImmutableMap.of(), conf);
