...
public class VectorizedParquetReaders {
  ...
  /**
   * Build the {@link VectorSchemaRootReader} for the expected schema and file schema.
   *
   ...
   */
  public static VectorSchemaRootReader buildReader(
      Schema expectedSchema,
      MessageType fileSchema,
      boolean setArrowValidityVector) {
    return (VectorSchemaRootReader)
        TypeWithSchemaVisitor.visit(expectedSchema.asStruct(), fileSchema,
            new VectorizedReaderBuilder(
                expectedSchema, fileSchema, setArrowValidityVector, ImmutableMap.of()));
  }
  ...
  private static class VectorizedReaderBuilder extends TypeWithSchemaVisitor<VectorizedReader<?>> {
    ...
    public VectorizedReader<?> message(
        ...
        List<org.apache.iceberg.parquet.VectorizedReader<?>> fieldReaders) {
      GroupType groupType = message.asGroupType();
      Map<Integer, org.apache.iceberg.parquet.VectorizedReader<?>> readersById = Maps.newHashMap();
      ...
      return new VectorSchemaRootReader(reorderedFields);
    }
