...
public class GenericTaskWriter<T extends StructLike> extends BaseTaskWriter<T> {
    ...
    public GenericTaskWriter(PartitionSpec spec,
        ...
        if (spec.isPartitioned()) {
            ...
            taskWriter = new PartitionedFanoutWriter<T>(spec, format, appenderFactory, fileFactory, io, targetFileSize) {
                @Override
            ...
            taskWriter = new UnpartitionedWriter<T>(spec, format, appenderFactory, fileFactory, io, targetFileSize);
        }
    }
