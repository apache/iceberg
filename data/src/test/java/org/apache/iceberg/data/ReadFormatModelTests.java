...
/**
 * Tests for the read side of the format model API.
 *
 * <p>Engines that support writing should extend {@link BaseFormatModelTests}, which adds the write
 * tests on top of these.
 *
...
public abstract class ReadFormatModelTests<T> {
  ...
  protected Schema supportedSchema(DataGenerator generator) {
  ...
  protected static List<Record> project(List<Record> records, Schema targetSchema) {
    if (records.isEmpty()) {
      return records;
    }
  ...
  protected EncryptedOutputFile encryptedFile;
                    ...
                    rebuilt.put(
                        ...
                        value == null
                            ...
                            : GenericRecord.create(valueType)
                                .copy("value_str", value.getField("value_str"), "value_int", 34)));
  ...
  protected static void assumeSupports(FileFormat fileFormat, String feature) {
  ...
  protected void readAndAssertEngineRecords(
      FileFormat fileFormat,
      Schema readSchema,
      List<Record> sourceRecords,
