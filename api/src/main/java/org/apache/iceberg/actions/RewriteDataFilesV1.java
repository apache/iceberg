...
public interface RewriteDataFilesV1 extends SnapshotUpdate<RewriteDataFilesV1, RewriteDataFilesV1.Result> {
   ...
   */
  RewriteDataFilesV1 filter(Expression expr);
   ...
   * @return this for method chaining
   */
  RewriteDataFilesV1 caseSensitive(boolean caseSensitive);
   ...
   * @return this for method chaining
   */
  RewriteDataFilesV1 outputSpecId(int specId);
   ...
   * @return this for method chaining
   */
  RewriteDataFilesV1 targetSizeInBytes(long targetSizeInBytes);
   ...
   * @return this for method chaining
   */
  RewriteDataFilesV1 splitLookback(int splitLookback);
   ...
   * @return this for method chaining
   */
  RewriteDataFilesV1 splitOpenFileCost(long splitOpenFileCost);
