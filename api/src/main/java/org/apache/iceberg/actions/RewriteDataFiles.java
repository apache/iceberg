...
public interface RewriteDataFiles
   ...
   *
   * @deprecated since 1.12.0, will be removed in 2.0.0; use {@code
   ...
   *
   * @deprecated since 1.12.0, will be removed in 2.0.0; use {@code
   *     SizeBasedFileRewritePlanner#TARGET_FILE_SIZE_BYTES} instead.
   */
  @Deprecated String TARGET_FILE_SIZE_BYTES = "target-file-size-bytes";
