 ...
 */
public class NativeFileEncryptParameters {
  private ByteBuffer fileAadPrefix;
  private Map<String, ByteBuffer> columnKeys;
  private ByteBuffer fileKey;

  private NativeFileEncryptParameters(Map<String, ByteBuffer> columnKeys, ByteBuffer fileKey,
  ...
  public static class Builder {
    ...
    public NativeFileEncryptParameters build() {
      return new NativeFileEncryptParameters(columnKeys, fileKey, fileAadPrefix);
    }
  }
