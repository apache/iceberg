...
public class Comparators {
  ...
  private static final ImmutableMap<Type.PrimitiveType, Comparator<?>> COMPARATORS =
      ImmutableMap.<Type.PrimitiveType, Comparator<?>>builder()
          ...
          .put(Types.TimestampType.microsWithZone(), Comparator.naturalOrder())
          .put(Types.TimestampType.microsWithoutZone(), Comparator.naturalOrder())
          .put(Types.TimestampType.nanosWithZone(), Comparator.naturalOrder())
          .put(Types.TimestampType.nanosWithoutZone(), Comparator.naturalOrder())
