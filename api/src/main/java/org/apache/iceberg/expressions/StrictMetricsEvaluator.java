...
public class StrictMetricsEvaluator {
  ...
  private class MetricsEvalVisitor extends BoundExpressionVisitor<Boolean> {
    ...
    public <T> Boolean startsWith(BoundReference<T> ref, Literal<T> lit) {
      // TODO: Handle cases that definitely match predicate, such as startsWith("x") when the bounds
      // are ["xa", "xz"]
      return ROWS_MIGHT_NOT_MATCH;
    }
    ...
    public <T> Boolean notStartsWith(BoundReference<T> ref, Literal<T> lit) {
      // TODO: Handle cases that definitely match predicate, such as notStartsWith("x") when the
      // bounds are ["a", "b"].
      return ROWS_MIGHT_NOT_MATCH;
    }
