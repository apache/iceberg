...
public interface TableScan {
  ...
  /**
   * Create a new {@link TableScan} to use a particular executor to access manifests. The default worker pool will be
   * used by default.
   *
   * @param executorService the provided executor.
   * @return a table scan which use the provided executor to access manifests.
   */
  TableScan accessManifestsWith(ExecutorService executorService);
