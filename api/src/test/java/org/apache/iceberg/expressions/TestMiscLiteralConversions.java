...
public class TestMiscLiteralConversions {
  ...
  public void testIdentityConversions() {
    List<Pair<Literal<?>, Type>> pairs =
        Arrays.asList(
            ...
            Pair.of(Literal.of("2017-08-18T14:21:01.919"), Types.TimestampnsType.withoutZone()),
  ...
  @Test
  public void testInvalidTimestampnsConversions() {
    testInvalidConversions(
        Literal.of("2017-08-18T14:21:01.919123456").to(Types.TimestampnsType.withoutZone()),
        Types.BooleanType.get(),
        Types.IntegerType.get(),
        Types.LongType.get(),
        Types.FloatType.get(),
