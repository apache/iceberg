...
public class TestStrictMetricsEvaluator {
  ...
  private static final DataFile FILE_2 =
      new TestDataFile(
          ...
          // lower bounds
          ImmutableMap.of(
              5, toByteBuffer(StringType.get(), "bbb"), 3, toByteBuffer(StringType.get(), "aa")),
          // upper bounds
          ImmutableMap.of(
              5, toByteBuffer(StringType.get(), "eee"), 3, toByteBuffer(StringType.get(), "dC")));
  ...
  private static final DataFile FILE_3 =
      new TestDataFile(
          ...
          // lower bounds
          ImmutableMap.of(
              5, toByteBuffer(StringType.get(), "bbb"), 3, toByteBuffer(StringType.get(), "1str1")),
          // upper bounds
          ImmutableMap.of(
              5,
  ...
  public void testStringNotStartsWith() {
    ...
    shouldRead =
        new StrictMetricsEvaluator(SCHEMA, notStartsWith("required", "1str1x"), true).eval(FILE_3);
    assertThat(shouldRead).as("Should read: range matches").isFalse();
    ...
    shouldRead =
        new StrictMetricsEvaluator(SCHEMA, notStartsWith("required", "3str3x"), true).eval(FILE_3);
    assertThat(shouldRead).as("Should read: range matches").isFalse();
