...
public abstract class BaseTimestampsProjection {
  public static final Types.TimestampType TYPE = Types.TimestampType.withoutZone();
  public static final Schema SCHEMA = new Schema(optional(1, "timestamp", TYPE));
