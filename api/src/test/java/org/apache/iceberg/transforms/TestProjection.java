...
public class TestProjection {
  ...
  public void testIdentityProjection() {
    ...
    for (UnboundPredicate<?> predicate : predicates) {
      ...
      assertThat(projected.ref().name())
          ...
          .isEqualTo("id");
      assertThat(projected.op()).as("Operation should match").isEqualTo(bound.op());

      if (bound.isLiteralPredicate()) {
        assertThat(projected.literal().value())
            .as("Literal should be equal")
            .isEqualTo(bound.asLiteralPredicate().literal().value());
      } else {
        assertThat(projected.literal()).as("Literal should be null").isNull();
      }
    }
  }
  ...
  public void testProjectionNames() {
    ...
    assertThat(predicate.ref().name())
        .as("should expected timestamp1_hour")
        .isEqualTo("timestamp1_hour");
    predicate =
        (UnboundPredicate<Integer>)
    ...
    assertThat(predicate.ref().name())
        .as("should expected timestamp2_day")
        .isEqualTo("timestamp2_day");
    predicate =
        (UnboundPredicate<Integer>)
    ...
    assertThat(predicate.ref().name())
        .as("should expected timestamp3_month")
        .isEqualTo("timestamp3_month");
    predicate =
        (UnboundPredicate<Integer>)
    ...
    assertThat(predicate.ref().name())
        .as("should expected timestamp4_year")
        .isEqualTo("timestamp4_year");
    predicate =
        (UnboundPredicate<Integer>)
    ...
    assertThat(predicate.ref().name()).as("should expected date1_day").isEqualTo("date1_day");
    predicate =
        (UnboundPredicate<Integer>)
    ...
    assertThat(predicate.ref().name()).as("should expected date2_month").isEqualTo("date2_month");
    predicate =
        (UnboundPredicate<Integer>)
    ...
    assertThat(predicate.ref().name()).as("should expected date3_year").isEqualTo("date3_year");
    predicate =
        (UnboundPredicate<Integer>)
    ...
    assertThat(predicate.ref().name()).as("should expected long_bucket").isEqualTo("long_bucket");
    predicate =
        (UnboundPredicate<Integer>)
    ...
    assertThat(predicate.ref().name()).as("should expected string_trunc").isEqualTo("string_trunc");
    predicate =
        (UnboundPredicate<Integer>)
