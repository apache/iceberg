...
public class TestTimestamps {
  ...
  public void testDeprecatedTimestampTransform() {
    ...
    assertThat((int) months.apply(nts.value())).as("Should produce -1").isEqualTo(-1);
    ...
    assertThat((int) days.apply(nts.value())).as("Should produce -1").isEqualTo(-1);
    ...
    assertThat((int) hours.apply(nts.value())).as("Should produce -1").isEqualTo(-1);
  }
  ...
  public void testTimestampTransform() {
    ...
    assertThat((int) months.bind(type).apply(pts.value()))
        ...
        .isZero();
    assertThat((int) months.bind(type).apply(nts.value())).as("Should produce -1").isEqualTo(-1);
    ...
    assertThat((int) days.bind(type).apply(pts.value()))
        ...
        .isZero();
    assertThat((int) days.bind(type).apply(nts.value())).as("Should produce -1").isEqualTo(-1);
    ...
    assertThat((int) hours.bind(type).apply(pts.value()))
        ...
        .isZero();
    assertThat((int) hours.bind(type).apply(nts.value())).as("Should produce -1").isEqualTo(-1);
  }
