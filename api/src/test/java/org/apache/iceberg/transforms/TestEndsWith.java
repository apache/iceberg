...
public class TestEndsWith {
  ...
  public void testTruncateProjections() {
    ...
    assertProjectionInclusive(spec, endsWith(COLUMN, "ababab"), "abab", Expression.Operation.ENDS_WITH);
    ...
    Expression projection = Projections.strict(spec).project(endsWith(COLUMN, "ababab"));
  ...
  public void testTruncateString() {
    ...
    Expression expr = endsWith(COLUMN, "abcde");
