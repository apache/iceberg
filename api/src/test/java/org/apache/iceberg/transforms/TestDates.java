...
public class TestDates {
  ...
  public void testDeprecatedDateTransform() {
    ...
    assertThat((int) months.apply(nd.value())).as("Should produce -1").isEqualTo(-1);

    Transform<Integer, Integer> days = Transforms.day(type);
    assertThat((int) days.apply(date.value())).as("Should produce 17501").isEqualTo(17501);
    assertThat((int) days.apply(pd.value())).as("Should produce 0 * 365 + 0 = 0").isZero();
    assertThat((int) days.apply(nd.value())).as("Should produce -1").isEqualTo(-1);
  }
  ...
  public void testDateTransform() {
    ...
    assertThat((int) months.bind(type).apply(pd.value()))
        ...
        .isZero();
    assertThat((int) months.bind(type).apply(nd.value())).as("Should produce -1").isEqualTo(-1);

    Transform<Integer, Integer> days = Transforms.day();
    assertThat((int) days.bind(type).apply(date.value()))
        .as("Should produce 17501")
        .isEqualTo(17501);
    assertThat((int) days.bind(type).apply(pd.value()))
        .as("Should produce 0 * 365 + 0 = 0")
        .isZero();
    assertThat((int) days.bind(type).apply(nd.value())).as("Should produce -1").isEqualTo(-1);
  }
  ...
  public void testDateToHumanString() {
    ...
    assertThat(year.toHumanString(type, year.bind(type).apply(date.value())))
        .as("Should produce the correct Human string")
        .isEqualTo("2017");
    ...
    assertThat(day.toHumanString(type, day.bind(type).apply(date.value())))
        .as("Should produce the correct Human string")
        .isEqualTo("2017-12-01");
  }
