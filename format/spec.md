...
| **`geometry`**     | Representation of a feature in planar (Euclidean) coordinate systems     |                                                  |
...
|            | _optional_ | **`primary-geo-column`** | Primary geometry column                                                                                                                                                                                                                                                                                                                                                                          |
|            | _optional_ | **`geometry-columns`** | A list (optional) of [geometry columns](#geometry-columns).                                                                                                                                                                                                                                                                                                                                      |
...
Geometry columns are column metadata which together with the associated column fully represents geometric data. Geometry
columns are informational, and can be  ignored by the reader. Geometry support is not required to read the table
correctly.
...
| **`geometry`**     |`{ "type": "bytes",`<br />&nbsp;&nbsp;`"logicalType": "geometry" }` | Stored using well-known-binary format (WKB) |                                                                                                                          |
...
| **`binary`**       | `binary`                                                           |                                             |                                                                |
| **`geometry`**     | `binary`                                                           | `GEOMETRY`                                  | Stored using well-known-binary format (WKB)                    |
| **`struct`**       | `group`                                                            |                                             |                                                                |
...
| **`binary`**       | `binary`            |                                                      |                                                                                         |
| **`geometry`**     | `binary`            | `iceberg.binary-type`=`GEOMETRY`                     | Stored using well-known-binary format (WKB)                                             |
| **`struct`**       | `struct`            |                                                      |                                                                                         |
| **`list`**         | `array`             |                                                      |                                                                                         |
| **`map`**          | `map`               |                                                      |                                                                                         |
...
| **`geometry`**     | `hashBytes(wellKnownBinary(v))`           | `POINT(59.9166947 10.7289657)` ￫ `-1569545297`               |
...
| **`geometry`**               | `JSON string: "geometry"`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | `"geometry"`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| **`geometry`**               | Well-known binary (WKB) format (without length)                                                              |
...
| **`geometry`**     | **`JSON string`**                         | `"POINT(59.9166947 10.7289657)"`           | Stored as a WKT-formatted string |
