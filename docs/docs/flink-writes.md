...
- **Table Format Version upgrade**: The dynamic sink does not support directly upgrading the underlying table from V2 to V3 when position deletes are present.
