...
| split-lookback                | connector.iceberg.split-lookback                | read.split.planning-lookback | 10                               | Number of bins to consider when combining input splits.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| aggregate-push-down-enabled   | table.exec.iceberg.aggregate-push-down-enabled  | N/A                          | false                            | Whether to push down aggregate (COUNT/MAX/MIN) evaluation to Iceberg, which computes results from data file metrics without reading data files.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
