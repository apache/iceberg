...
# Iceberg GCP-Bigquery Integrations

Iceberg provides integration with different GCP services through the `iceberg-aws` module. 
This section describes how to use Iceberg with GCP.
