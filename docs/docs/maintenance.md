...
Iceberg uses metadata in its manifest list and manifest files to speed up query planning and prune unnecessary data files. The metadata tree functions as an index over a table's data.
