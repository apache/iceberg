...
| `partial-progress.max-failed-commits` | value of `partital-progress.max-commits` | Maximum amount of failed commits is allowed before job failure, if partial progress is enabled |
