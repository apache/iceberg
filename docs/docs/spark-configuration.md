...
| streaming-start-from | `earliest` | Controls where the stream begins when there is no checkpoint. See [Starting offsets](spark-structured-streaming.md#starting-offsets) for accepted values. |
