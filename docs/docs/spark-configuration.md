...
| spark.sql.iceberg.planning.preserve-data-grouping      | false                                                          | Whether to preserve the existing grouping of data while planning splits (used in Storage Partitioned Joins)                      |
