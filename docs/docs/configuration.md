...
| write.wap.enabled                                   | false                       | Enables write-audit-publish writes. See [Write-Audit-Publish](spark-writes.md#write-audit-publish-wap) for usage with `spark.wap.id` and `spark.wap.branch`                                                                                       |
