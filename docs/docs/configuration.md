...
| write.parquet.row-group-row-limit                   | Integer.MAX_VALUE (no limit) | Parquet row group row count limit; row groups are flushed once this many rows have been written                                                                                                                                                   |
