...
| write.parquet.stats-enabled.column.default           | true                        | Default flag to enable parquet column statistics for all columns in the table                                                                                                                     |
| write.parquet.stats-enabled.column.col1              | (not set)                   | Flag to enable parquet column statistics for column 'col1' to allow per-column tuning                                                                                                             |
