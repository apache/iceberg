...
| write.avro.local-timestamp.enabled                  | false                       | Encode 'timestamp(_ns)' using 'local-timestamp-(micros\|nanos)' logical types instead of 'timestamp-(micros\|nanos)' with 'adjust-to-utc=false' property                                                                    |
