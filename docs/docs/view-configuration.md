...
| replace.append-dialect.allowed   | false                       | Controls whether additional SQL dialects are appened during a replace operation. Cannot be enabled together with `replace.drop-dialect.allowed` |
