...
!!! warning "Hive Catalog Limitation"
    ...
    To work around this, set `hive.metastore.disallow.incompatible.col.type.changes=false` in `hive-site.xml`
    or add the equivalent property to the Hive catalog configuration.
