...
For example, to use AWS features with Spark 3.4 (with scala 2.12) and AWS clients version 2.20.18 (which is packaged in the `iceberg-aws-bundle`), you can start the Spark SQL shell with:
