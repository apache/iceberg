...
| write.parquet.row-group-check-min-record-count      | 100                        | The minimum count of rows of checks of the page size and row group size                                                                                                                           |
| write.parquet.row-group-check-max-record-count      | 10000                      | The maximum count of rows of checks of the page size and row group size                                                                                                                           |
