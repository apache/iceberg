...
import static org.apache.iceberg.flink.sink.committer.ManifestOutputFileFactory.FLINK_MANIFEST_LOCATION;
...
public class TestFlinkManifest {
  ...
  public void testUserProvidedManifestLocation() throws IOException {
    ...
    ManifestOutputFileFactory factory = new ManifestOutputFileFactory(() -> table, props, "prefix");
  ...
  public void testVersionedSerializer() throws IOException {
    long checkpointId = 1;
    ManifestOutputFileFactory factory =
        new ManifestOutputFileFactory(() -> table, table.properties(), "prefix");
