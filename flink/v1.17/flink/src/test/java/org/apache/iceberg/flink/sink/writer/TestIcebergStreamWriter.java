...
public class TestIcebergStreamWriter {
  ...
  private OneInputStreamOperatorTestHarness<RowData, WriteResult> createIcebergStreamWriter(
    ...
    Map<String, String> writeProperties =
        SinkTestUtil.writeProperties(
            icebergTable, flinkWriteConfig.dataFileFormat(), flinkWriteConfig);

    IcebergStreamWriter<RowData> streamWriter =
        IcebergStreamWriter.createStreamWriter(
            () -> icebergTable, flinkWriteConfig, writeProperties, flinkRowType, null);
