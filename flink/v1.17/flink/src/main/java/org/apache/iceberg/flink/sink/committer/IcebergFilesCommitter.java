...
public class IcebergFilesCommitter extends AbstractStreamOperator<Void>
  ...
  public void initializeState(StateInitializationContext context) throws Exception {
    ...
    this.commonCommitter =
        new CommonCommitter(
            ...
            replacePartitions,
            workerPoolSize,
            String.format("%s-%s-%05d-%d", flinkJobId, operatorUniqueId, subTaskId, attemptId));
    commonCommitter.init(committerMetrics);
    ...
    if (context.isRestored()) {
      ...
      this.maxCommittedCheckpointId =
          commonCommitter.getMaxCommittedCheckpointId(restoredFlinkJobId, operatorUniqueId);
  ...
  public void snapshotState(StateSnapshotContext context) throws Exception {
    ...
    dataFilesPerCheckpoint.put(
        checkpointId, commonCommitter.writeToManifest(writeResultsOfCurrentCkpt, checkpointId));
  ...
  public void endInput() throws IOException {
    ...
    dataFilesPerCheckpoint.put(
        currentCheckpointId,
        commonCommitter.writeToManifest(writeResultsOfCurrentCkpt, currentCheckpointId));
    writeResultsOfCurrentCkpt.clear();
