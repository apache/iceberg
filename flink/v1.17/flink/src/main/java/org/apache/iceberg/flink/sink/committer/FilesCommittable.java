...
public class FilesCommittable implements Serializable {
   ...
   */
  public static WriteResult readFromManifest(FilesCommittable committable, FileIO io, Map<Integer, PartitionSpec> specsById)
      throws IOException {
    ...
    return FlinkManifestUtil.readCompletedFiles(deltaManifests, io, specsById);
  }
