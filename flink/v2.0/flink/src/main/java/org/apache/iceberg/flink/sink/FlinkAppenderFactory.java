  ...
  public DataWriter<RowData> newDataWriter(
    ...
    try {
      DataWriteBuilder<?, RowType, RowData> builder =
          FlinkFileAccessor.INSTANCE.dataWriteBuilder(format, file);
      return builder
          .dataSchema(flinkSchema)
          .set(props)
          .fileSchema(schema)
  ...
  public EqualityDeleteWriter<RowData> newEqDeleteWriter(
    ...
    try {
      EqualityDeleteWriteBuilder<?, RowType, RowData> builder =
          FlinkFileAccessor.INSTANCE.equalityDeleteWriteBuilder(format, outputFile);
      return builder
          .overwrite()
          .set(props)
          .metricsConfig(metricsConfig)
  ...
  public PositionDeleteWriter<RowData> newPosDeleteWriter(
    ...
    try {
      PositionDeleteWriteBuilder<?, RowType, RowData> builder =
          FlinkFileAccessor.INSTANCE.positionDeleteWriteBuilder(format, outputFile);
      return builder
          .overwrite()
          .set(props)
          .metricsConfig(metricsConfig)
