...
public class TestSortKeySerializerSnapshot {
  ...
  public void testSnapshotIsCompatibleWithSameSortOrder() throws Exception {
    ...
    SortKeySerializer.SortKeySerializerSnapshot newSnapshot =
        roundTrip(new SortKeySerializer.SortKeySerializerSnapshot(schema, sortOrder));
  ...
  public void testSnapshotIsCompatibleWithRemoveNonSortField() throws Exception {
    ...
    SortKeySerializer.SortKeySerializerSnapshot newSnapshot =
        roundTrip(new SortKeySerializer.SortKeySerializerSnapshot(newSchema, newSortOrder));
  ...
  public void testSnapshotIsIncompatibleWithAddSortField() throws Exception {
    ...
    SortKeySerializer.SortKeySerializerSnapshot newSnapshot =
        roundTrip(new SortKeySerializer.SortKeySerializerSnapshot(schema, newSortOrder));
