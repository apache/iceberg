...
public class TestIcebergSink extends TestFlinkIcebergSinkBase {
  ...
  public TestIcebergSink(String format, int parallelism, boolean partitioned) {
  ...
  public void testTwoSinksInDisjointedDAG() throws Exception {
    ...
    rightTable.refresh();
    Assert.assertEquals(
        TestIcebergSink.class.getName(), rightTable.currentSnapshot().summary().get("flink.test"));
