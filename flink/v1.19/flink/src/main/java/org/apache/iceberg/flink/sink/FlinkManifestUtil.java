...
public class FlinkManifestUtil {
  ...
  public static ManifestOutputFileFactory createOutputFileFactory(
      Supplier<Table> tableSupplier, Map<String, String> props, String jobId, String operatorId) {
    return new ManifestOutputFileFactory(tableSupplier, props, jobId, operatorId);
  }
