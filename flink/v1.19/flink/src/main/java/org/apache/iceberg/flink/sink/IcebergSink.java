...
public class IcebergSink
  ...
  public Committer<IcebergCommittable> createCommitter(CommitterInitContext context) {
    IcebergFilesCommitterMetrics metrics =
        new IcebergFilesCommitterMetrics(context.metricGroup(), initTable.name());
  ...
  public static class Builder {
    ...
    public IcebergSink build() {
      ...
      int workerPoolSize = flinkWriteConf.workerPoolSize();
      ...
      if (tableRefreshInterval != null) {
        ...
        tableSerializableSupplier = new SimpleTableSupplier((SerializableTable) table);
      }

      Table initTable = tableSerializableSupplier.get();
      ...
      FileFormat dataFileFormat = flinkWriteConf.dataFileFormat();
      long targetDataFileSize = flinkWriteConf.targetDataFileSize();
   ...
   */
  private static class SimpleTableSupplier implements SerializableSupplier<Table> {
