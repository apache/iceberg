...
public class TestFlinkMetaDataTable extends CatalogTestBase {
  ...
  public void testPartitionsTableDvCount() {
    ...
    List<Row> actual =
        sql("SELECT dv_count, position_delete_file_count FROM %s$partitions", dvTableName);
    assertThat(actual).hasSize(2);
    assertThat((int) actual.get(0).getField(0)).isEqualTo(1);
    assertThat((int) actual.get(0).getField(1)).isEqualTo(1);
    assertThat((int) actual.get(1).getField(0)).isEqualTo(1);
    assertThat((int) actual.get(1).getField(1)).isEqualTo(1);
