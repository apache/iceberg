...
class ShuffleOperator<T, K> extends AbstractStreamOperator<ShuffleRecordWrapper<T, K>>
  ...
  private transient DataStatistics<K> globalDataStatistics;
  private transient ListState<DataStatistics<K>> globalDataStatisticsState;
  private transient DataStatisticsFactory<K> dataStatisticsFactory;
  ...
  ListStateDescriptor<DataStatistics<K>> generateGlobalDataDistributionWeightDescriptor() {
    return new ListStateDescriptor<>(
        "globalDataStatisticsState", TypeInformation.of(new TypeHint<DataStatistics<K>>() {}));
  }
