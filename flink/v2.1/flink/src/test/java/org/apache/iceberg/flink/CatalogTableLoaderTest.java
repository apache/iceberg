...
public class CatalogTableLoaderTest {
    ...
    static class SerializableCatalogLoader implements org.apache.iceberg.flink.CatalogLoader, Serializable {
        private static final long serialVersionUID = 1L;

        @Override
        public Catalog loadCatalog() {
            // Create a simple Table proxy object
            Table tableProxy = (Table) Proxy.newProxyInstance(
    ...
    public void testOpenLoadClose() throws Exception {
        ...
        org.apache.iceberg.flink.TableLoader loader = org.apache.iceberg.flink.TableLoader.fromCatalog(catalogLoader, IDENTIFIER);
    ...
    public void testSerializationKeepsLoaderFunctional() throws Exception {
        org.apache.iceberg.flink.CatalogLoader catalogLoader = new SerializableCatalogLoader();
        org.apache.iceberg.flink.TableLoader original = org.apache.iceberg.flink.TableLoader.fromCatalog(catalogLoader, IDENTIFIER);
