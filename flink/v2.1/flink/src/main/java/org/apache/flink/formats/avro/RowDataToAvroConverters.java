    ...
    switch (type.getTypeRoot()) {
      ...
      case TIMESTAMP_WITHOUT_TIME_ZONE:
        ...
        if (type instanceof org.apache.flink.table.types.logical.TimestampType) {
          tzPrecision = ((org.apache.flink.table.types.logical.TimestampType) type).getPrecision();
        } else {
          tzPrecision = 3;
        }
  ...
  private static RowDataToAvroConverter createMapConverter(
    ...
    return new RowDataToAvroConverter() {
      ...
      public Object convert(Schema schema, Object object) {
        ...
        final Map<Object, Object> map = CollectionUtil.newHashMapWithExpectedSize(mapData.size());
        for (int i = 0; i < mapData.size(); ++i) {
          final String key = keyArray.getString(i).toString();
          final Object value =
              valueConverter.convert(valueSchema, valueGetter.getElementOrNull(valueArray, i));
          map.put(key, value);
        }
        return map;
      }
