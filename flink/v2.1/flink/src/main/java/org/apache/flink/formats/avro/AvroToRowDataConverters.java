...
public class AvroToRowDataConverters {
  ...
  private static TimestampData convertToTimestamp(Object object, LogicalType type) {
    int precision = 3;
    if (type instanceof org.apache.flink.table.types.logical.TimestampType) {
      precision = ((org.apache.flink.table.types.logical.TimestampType) type).getPrecision();
    } else if (type instanceof org.apache.flink.table.types.logical.LocalZonedTimestampType) {
      precision =
