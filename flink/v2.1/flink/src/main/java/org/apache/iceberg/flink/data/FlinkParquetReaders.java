...
public class FlinkParquetReaders {
  ...
  private static class ReadBuilder extends TypeWithSchemaVisitor<ParquetValueReader<?>> {
    ...
    public ParquetValueReader<?> variant(
        Types.VariantType expected, GroupType group, ParquetValueReader<?> result) {
      if (expected == null) {
        return null;
      }

      return new VariantReader(result);
    }
  ...
  private static class VariantReader extends ParquetVariantReaders.DelegatingValueReader<org.apache.iceberg.variants.Variant, Variant> {
    @SuppressWarnings("unchecked")
