...
public class FlinkSink {
  ...
  public static class Builder {
    ...
    private List<String> equalityFieldNames = null;
    ...
    public Builder equalityFieldNames(List<String> columnNames) {
      this.equalityFieldNames = columnNames;
      return this;
    }
    ...
    public DataStreamSink<RowData> build() {
      ...
      if (equalityFieldNames != null && !equalityFieldNames.isEmpty()) {
        for (String fieldName : equalityFieldNames) {
          org.apache.iceberg.types.Types.NestedField field = table.schema().findField(fieldName);
          Preconditions.checkNotNull(field, "Field with name '%s' does not exist", fieldName);
