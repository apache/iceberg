...
/**
 * @author l00561823/李立伟
 * @since 2021/8/21
 */
abstract class FlinkSinkBase {
  private static final Logger LOG = LoggerFactory.getLogger(FlinkSinkBase.class);
  ...
  public abstract static class Builder<T extends Builder<T>> {
    protected Function<String, DataStream<RowData>> inputCreator = null;
    protected TableLoader tableLoader;
    protected Table table;
    protected TableSchema tableSchema;
    protected boolean overwrite = false;
    protected DistributionMode distributionMode = null;
    protected Integer writeParallelism = null;
    protected List<String> equalityFieldColumns = null;
    protected String uidPrefix = null;

    protected T forRowData(DataStream<RowData> newRowDataInput) {
      this.inputCreator = ignored -> newRowDataInput;
      return self();
    }

    protected <R> T forMapperOutputType(
        DataStream<R> input,
        MapFunction<R, RowData> mapper,
     ...
     * @return {@link FlinkSink.Builder} to connect the iceberg table.
     */
    public T tableLoader(TableLoader newTableLoader) {
      this.tableLoader = newTableLoader;
      return self();
    }

    public T tableSchema(TableSchema newTableSchema) {
      this.tableSchema = newTableSchema;
      return self();
    }

    public T overwrite(boolean newOverwrite) {
     ...
     * @return {@link FlinkSink.Builder} to connect the iceberg table.
     */
    public T distributionMode(DistributionMode mode) {
     ...
     * @return {@link FlinkSink.Builder} to connect the iceberg table.
     */
    public T writeParallelism(int newWriteParallelism) {
     ...
     * @return {@link FlinkSink.Builder} to connect the iceberg table.
     */
    public T uidPrefix(String newPrefix) {
    ...
    protected String operatorName(String suffix) {
