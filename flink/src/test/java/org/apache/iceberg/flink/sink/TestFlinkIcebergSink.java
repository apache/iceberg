...
public class TestFlinkIcebergSink {
  ...
  public void testTwoSinksInDisjointedDAG() throws Exception {
    ...
    // TODO - Hack to debug timeouts in CI. Still need to fix root issue.
    //
    // Occasionally, Github CI will timeout after 6 hours with the following log
    // found in the info level gradle logs:
    //     [Checkpoint Timer] INFO org.apache.flink.runtime.checkpoint.CheckpointCoordinator - Checkpoint triggering
    //     task Source: leftCustomSource -> leftIcebergSink-leftIcebergSink -> leftIcebergSink-IcebergStreamWriter
    //     (1/1) of job c7373686a7bdb7ab86d099cba18cc1b2 is not in state RUNNING but FINISHED instead.
    //     Aborting checkpoint.
    //
    // It's possible that one side's tasks finish first, while the other side is still checkpointing.
    // Further information can be found here:
    //   https://cwiki.apache.org/confluence/display/FLINK/FLIP-147%3A+Support+Checkpoints+After+Tasks+Finished
    //
    // See https://github.com/apache/iceberg/issues/3091
