...
public class TestRecyclableArrayIterator {
  ...
  public void testEmptyConstruction() {
    // dummy recycler
    final RecyclableArrayIterator<Object> iter = new RecyclableArrayIterator<>(ignored -> System.currentTimeMillis());
  ...
  public void testGetElements() {
    ...
    iter.set(elements, elements.length, initialOffset, initialSkipCount);
