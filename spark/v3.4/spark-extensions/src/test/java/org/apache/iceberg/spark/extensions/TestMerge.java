...
public abstract class TestMerge extends SparkRowLevelOperationsTestBase {
  ...
  public void testMergeWithNonExistingColumns() {
    ...
    Assertions.assertThatThrownBy(
        ...
        .hasMessageStartingWith("cannot resolve t.invalid_col");
    ...
    Assertions.assertThatThrownBy(
            () ->
                sql(
                    ...
                    commitTarget()))
        .isInstanceOf(AnalysisException.class)
        .hasMessageStartingWith("[FIELD_NOT_FOUND] No such struct field");
    ...
    Assertions.assertThatThrownBy(
            () ->
                sql(
                    ...
                    commitTarget()))
        .isInstanceOf(AnalysisException.class)
        .hasMessageStartingWith("cannot resolve invalid_col in MERGE command");
  }
    ...
    Assertions.assertThatThrownBy(
            () ->
                sql(
                    ...
                    commitTarget()))
        .isInstanceOf(AnalysisException.class)
        .hasMessageStartingWith("Nested fields are not supported inside INSERT clauses");
    ...
    Assertions.assertThatThrownBy(
            () ->
                sql(
                    ...
                    commitTarget()))
        .isInstanceOf(AnalysisException.class)
        .hasMessage("Duplicate column names inside INSERT clause: id");
    ...
    Assertions.assertThatThrownBy(
            () ->
                sql(
                    ...
                    commitTarget()))
        .isInstanceOf(AnalysisException.class)
        .hasMessageStartingWith("Cannot find column 'c'")
    ...
    Assertions.assertThatThrownBy(
            () ->
                sql(
                    ...
                    commitTarget()))
        .isInstanceOf(AnalysisException.class)
        .hasMessageStartingWith("Updating nested fields is only supported for structs");
    ...
    Assertions.assertThatThrownBy(
            () ->
                sql(
                    ...
                    commitTarget()))
        .isInstanceOf(AnalysisException.class)
        .hasMessage("Updates are in conflict for these columns: id");
    ...
    Assertions.assertThatThrownBy(
            () ->
                sql(
                    ...
                    commitTarget()))
        .isInstanceOf(AnalysisException.class)
        .hasMessage("Updates are in conflict for these columns: c.n1");
    ...
    Assertions.assertThatThrownBy(
            () ->
                sql(
                    ...
                    commitTarget()))
        .isInstanceOf(AnalysisException.class)
        .hasMessage("Updates are in conflict for these columns: c.n1, c");
  }
            ...
            Assertions.assertThatThrownBy(
                    () ->
                        sql(
                            ...
                            commitTarget()))
                .isInstanceOf(AnalysisException.class)
                .hasMessage("Cannot write nullable values to non-null column 'id'");
            ...
            Assertions.assertThatThrownBy(
                    () ->
                        sql(
                            ...
                            commitTarget()))
                .isInstanceOf(AnalysisException.class)
                .hasMessage("Cannot write nullable values to non-null column 'n1'");
    ...
    Assertions.assertThatThrownBy(
            () ->
                sql(
                    ...
                    commitTarget()))
        .isInstanceOf(AnalysisException.class)
        .hasMessageStartingWith("Non-deterministic functions are not supported");
    ...
    Assertions.assertThatThrownBy(
            () ->
                sql(
                    ...
                    commitTarget()))
        .isInstanceOf(AnalysisException.class)
        .hasMessageStartingWith("Agg functions are not supported");
    ...
    Assertions.assertThatThrownBy(
            () ->
                sql(
                    ...
                    commitTarget()))
        .isInstanceOf(AnalysisException.class)
        .hasMessageStartingWith("Subqueries are not supported in conditions");
    ...
    Assertions.assertThatThrownBy(
            () ->
                sql(
                    ...
                    commitTarget()))
        .isInstanceOf(AnalysisException.class)
        .hasMessageStartingWith("Cannot resolve [c2]");
  }
