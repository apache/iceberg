...
public class TestCopyOnWriteMergeAPI extends TestMergeAPI {

  public TestCopyOnWriteMergeAPI(
      String catalogName,
            ...
            () -> {
              for (int numOperations = 0; numOperations < Integer.MAX_VALUE; numOperations++) {
                ...
                IcebergMergeInto.table(tableName)
                    ...
                    .on(format("%s.id = source.value", tableName))
                    .whenMatched()
                    .update(
  ...
  public void testRuntimeFilteringWithReportedPartitioning() {
    ...
    Dataset<Row> source = spark.createDataset(Collections.singletonList(2), Encoders.INT()).toDF();
