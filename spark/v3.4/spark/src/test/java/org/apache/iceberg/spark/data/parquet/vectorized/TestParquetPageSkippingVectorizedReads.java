...
public class TestParquetPageSkippingVectorizedReads extends AvroDataTestBase {
  ...
  page-0                 21370                   213                     0
  page-1                 21583                   213                   100
  page-2                 21796                   213                   200
  page-3                 22009                   216                   300
  page-4                 22225                   217                   400
  page-5                 22442                   216                   500
  page-6                 22658                    87                   600
  row-group 1:
  column index for column l:
                    null count                   min                  max
  ...
  offset index for column l:
                        offset       compressed size       first row index
  page-0                117388                   217                     0
  page-1                117605                   216                   100
  page-2                117821                   217                   200
  page-3                118038                   188                   300
  */
  ...
  public void testMultipleRowGroupsMatch() {
    ...
    List<Record> expected =
        selectRecords(allRecords, Pair.of(100, 200), Pair.of(300, 500), Pair.of(719, 919));
    readAndValidate(filter, expected);
  }
