...
class SparkPositionDeltaWrite implements DeltaWrite, RequiresDistributionAndOrdering {
  ...
  SparkPositionDeltaWrite(
    ...
    this.writeProperties = WritePropertiesUtil.writeProperties(context.dataFileFormat, writeConf);
  }
  ...
  private static class PositionDeltaWriteFactory implements DeltaWriterFactory {
    ...
    PositionDeltaWriteFactory(Broadcast<Table> tableBroadcast, Command command, Context context, Map<String, String> writeProperties) {
