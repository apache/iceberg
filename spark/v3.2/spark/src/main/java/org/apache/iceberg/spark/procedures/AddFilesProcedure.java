...
class AddFilesProcedure extends BaseProcedure {
  ...
  public InternalRow[] call(InternalRow args) {
    ...
    long addedFilesCount = importToIceberg(tableIdent, sourceIdent, partitionFilter, checkDuplicateFiles, parallelism);
  ...
  private long importToIceberg(Identifier destIdent, Identifier sourceIdent, Map<String, String> partitionFilter,
    ...
    return modifyIcebergTable(destIdent, table -> {
      ...
      if (isFileIdentifier(sourceIdent)) {
        ...
        importFileTable(table, sourcePath, format, partitionFilter, checkDuplicateFiles, parallelism);
      } else {
        importCatalogTable(table, sourceIdent, partitionFilter, checkDuplicateFiles, parallelism);
      }
