...
class SetCurrentSnapshotProcedure extends BaseProcedure {
  ...
  public static ProcedureBuilder<SetCurrentSnapshotProcedure> builder() {
    return new ProcedureBuilder<SetCurrentSnapshotProcedure>() {
      @Override
      public SetCurrentSnapshotProcedure build(ProcedureBuilderHelper helper) {
        return new SetCurrentSnapshotProcedure(helper.plugin(TableCatalog.class));
      }
    };
  }
