 ...
 * @param viewChain The chain of view identifiers that reference this table, ordered from
 *                  outermost view first to innermost view last. Each element is a multipart
