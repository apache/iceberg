...
/**
 * Data source for loading and writing Iceberg tables using the "iceberg" format.
 *
 * <p>The path parameter is resolved in the following priority order:
 *
 * <ol>
 *   <li>Rewrite catalog - If path is in the table cache, loads from the rewrite catalog
 *   <li>File path - If path contains "/", loads a HadoopTable at the specified path
 *   <li>Catalog identifier - Otherwise resolves as:
 *       <ul>
