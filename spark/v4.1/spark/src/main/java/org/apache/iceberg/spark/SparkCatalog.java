...
public class SparkCatalog extends BaseCatalog {
  ...
  public void renameTable(Identifier from, Identifier to)
    ...
    try {
      checkNotPathIdentifier(from, "rename");
      checkNotPathIdentifier(to, "rename");
  ...
  private static void checkNotPathIdentifier(Identifier ident, String operation) {
    Preconditions.checkArgument(
        !(ident instanceof PathIdentifier),
        "Cannot perform %s operation on path-based table: %s",
        operation,
        ident);
  }
