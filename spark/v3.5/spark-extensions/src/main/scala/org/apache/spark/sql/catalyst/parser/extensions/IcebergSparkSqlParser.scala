...
object IcebergSparkSqlParser extends SparkSqlParser {
  override val astBuilder = new IcebergSparkSqlAstBuilder

  class IcebergSparkSqlAstBuilder extends SparkSqlAstBuilder {
    /**
     * Resolve/create a primitive type, with additional support for geometry type.
     */
