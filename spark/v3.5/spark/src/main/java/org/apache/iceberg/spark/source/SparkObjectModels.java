...
public class SparkObjectModels {
  ...
  public static void register() {
    FileAccessFactoryRegistry.registerFileAccessFactory(
        new Avro.FileAccessFactory<StructType, InternalRow>(
            SPARK_OBJECT_MODEL,
    ...
    FileAccessFactoryRegistry.registerFileAccessFactory(
        new Parquet.FileAccessFactory<InternalRow, DeleteFilter<InternalRow>, StructType>(
            SPARK_OBJECT_MODEL,
    ...
    FileAccessFactoryRegistry.registerFileAccessFactory(
        new Parquet.FileAccessFactory<ColumnarBatch, DeleteFilter<InternalRow>, StructType>(
            SPARK_VECTORIZED_OBJECT_MODEL, VectorizedSparkParquetReaders::buildReader));

    FileAccessFactoryRegistry.registerFileAccessFactory(
        new ORC.FileAccessFactory<StructType, InternalRow>(
            SPARK_OBJECT_MODEL,
            SparkOrcReader::new,
    ...
    FileAccessFactoryRegistry.registerFileAccessFactory(
        new ORC.FileAccessFactory<StructType, ColumnarBatch>(
