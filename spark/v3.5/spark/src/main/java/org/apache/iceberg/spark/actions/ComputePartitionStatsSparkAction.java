 ...
 * metadata. Uses default branch if not specified.
 */
public class ComputePartitionStatsSparkAction
  ...
  @Override
  public ComputePartitionStats branch(String branchName) {
  ...
  private String jobDesc() {
    return String.format("Computing partition stats for %s (branch=%s)", table.name(), branch);
  }
}
