...
public class TestRemoveDanglingDeleteAction extends TestBase {
  ...
  public void testUnpartitionedTable() {
    ...
    DeleteFile unpartitionedDeletes = fileUnpartitionedDeletes();
    table
        .newRowDelta()
        .addDeletes(unpartitionedDeletes)
    ...
    assertThat(removedDeleteFiles)
        ...
        .hasSize(2)
        .containsExactlyInAnyOrder(
            unpartitionedDeletes.location(), FILE_UNPARTITIONED_EQ_DELETE.location());
  }
  ...
  public void testWithBranch() {
    ...
    assertThat(removedDeleteFiles)
        ...
        .hasSize(2)
        .containsExactlyInAnyOrder(fileADeletes.location(), FILE_A_EQ_DELETES.location());
  }
