...
public class SparkView {
  ...
  private static String[] queryColumnNames(Map<String, String> properties, String schemaMode) {
    ...
    String queryColumnNames = properties.get(QUERY_COLUMN_NAMES_JSON);
    if (queryColumnNames == null) {
      queryColumnNames = properties.get(QUERY_COLUMN_NAMES);
    }

    return queryColumnNames != null && !queryColumnNames.isEmpty()
        ? SparkViewQueryColumnNamesParser.fromProperty(queryColumnNames)
        : new String[0];
  }
