...
public class SparkCatalog extends BaseCatalog {
    ...
    try {
      ...
      switch (viewCommit) {
        case CREATE:
          ...
          break;
        case REPLACE:
          replacedProperties = sparkVisibleProperties(viewIdentifier);
  ...
  private Pair<Set<String>, org.apache.iceberg.view.View> createOrReplaceView(
    ...
    try {
      Set<String> replacedProperties = sparkVisibleProperties(viewIdentifier);
  ...
  private Set<String> sparkVisibleProperties(TableIdentifier identifier) {
    org.apache.iceberg.view.View view = asViewCatalog.loadView(identifier);
    Set<String> properties =
        Sets.newHashSet(SparkView.toView(catalogName, view).properties().keySet());
