...
class PageSkippingHelpers {
  ...
  private static final DynConstructors.Ctor<RowRanges> RANGES_LIST_CTOR =
      DynConstructors.builder().hiddenImpl(RowRanges.class, List.class).build();
  ...
  private static final DynMethods.StaticMethod UNION =
      DynMethods.builder("union")
  ...
  private static final DynMethods.StaticMethod INTERSECTION =
      DynMethods.builder("intersection")
          .hiddenImpl(RowRanges.class, RowRanges.class, RowRanges.class)
          .buildStatic();
  ...
  private static final DynMethods.StaticMethod ROW_RANGES_CREATE =
      DynMethods.builder("create")
          .hiddenImpl(RowRanges.class, long.class, PrimitiveIterator.OfInt.class, OffsetIndex.class)
          .buildStatic();

  static RowRanges createRowRanges(
  ...
  private static final DynMethods.StaticMethod ROW_RANGES_CREATE_SINGLE =
      DynMethods.builder("createSingle").hiddenImpl(RowRanges.class, long.class).buildStatic();

  static RowRanges allRows(long rowCount) {
    return ROW_RANGES_CREATE_SINGLE.invoke(rowCount);
  }

  private static final DynMethods.StaticMethod INDEX_ITERATOR_ALL =
      DynMethods.builder("all")
  ...
  private static final DynMethods.StaticMethod INDEX_ITERATOR_FILTER =
  ...
  private static final DynMethods.UnboundMethod INTERNAL_READ_FILTERED_ROW_GROUP =
      DynMethods.builder("internalReadFilteredRowGroup")
          .hiddenImpl(
              ...
              BlockMetaData.class,
              RowRanges.class,
              ColumnIndexStore.class)
          .build();

  static PageReadStore internalReadFilteredRowGroup(
      ParquetFileReader reader, int blockIndex, RowRanges rowRanges) {
    ...
    return INTERNAL_READ_FILTERED_ROW_GROUP.invoke(
        reader, blockMetaData, rowRanges, columnIndexStore);
  }
}
