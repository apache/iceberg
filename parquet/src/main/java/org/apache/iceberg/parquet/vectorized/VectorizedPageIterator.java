...
public class VectorizedPageIterator {
  ...
  private boolean allPagesDictionaryEncoded;
  ...
  public void setDictionaryForColumn(Dictionary dict, boolean allPagesDictEncoded) {
    ...
    this.allPagesDictionaryEncoded = allPagesDictEncoded;
  }
  ...
  private void initDataReader(Encoding dataEncoding, ByteBufferInputStream in, int valueCount) {
    ...
    this.eagerDecodeDictionary = dataEncoding.usesDictionary() && dictionary != null && !allPagesDictionaryEncoded;
  ...
  private void initFromPage(DataPageV1 dataPageV1) {
    ...
    ValuesReader dlReader = this.definitionLevelReader;
  ...
  class ValuesReaderIntIterator extends IntIterator {
    private ValuesReader delegate;

    ValuesReaderIntIterator(ValuesReader dg) {
      this.delegate = dg;
    }
  ...
  class RLEIntIterator extends IntIterator {
    ...
    RLEIntIterator(RunLengthBitPackingHybridDecoder dg) {
      this.delegate = dg;
    }
  ...
  private final class NullIntIterator extends IntIterator {
    @Override
    int nextInt() {
      return 0;
    }
