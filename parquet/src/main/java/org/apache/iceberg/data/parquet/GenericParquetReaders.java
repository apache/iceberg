...
public class GenericParquetReaders extends BaseParquetReaders<Record> {
  ...
  @Override
  protected ParquetValueReaders.PrimitiveReader<?> dateReader(ColumnDescriptor desc) {
    return new DateReader(desc);
  }

  @Override
  protected ParquetValueReaders.PrimitiveReader<?> timeReader(
    ...
    } else if (unit == LogicalTypeAnnotation.TimeUnit.MILLIS) {
  ...
  @Override
  protected ParquetValueReaders.PrimitiveReader<?> timestampReader(
  ...
  @Override
  protected ParquetValueReaders.PrimitiveReader<?> uuidReader(ColumnDescriptor desc) {
    return null;
  }
