...
public abstract class BaseParquetWriter<T> {
  ...
  protected abstract ParquetValueWriters.PrimitiveWriter<?> dateWriter(ColumnDescriptor desc);

  protected abstract ParquetValueWriters.PrimitiveWriter<?> timeWriter(ColumnDescriptor desc);

  protected abstract ParquetValueWriters.PrimitiveWriter<?> timestampWriter(
      ColumnDescriptor desc, boolean isAdjustedToUTC);

  protected abstract ParquetValueWriters.PrimitiveWriter<?> uuidWriter(ColumnDescriptor desc);
