...
public class TestSnapshotDeltaLakeKernelTable extends SparkDeltaLakeSnapshotTestBase {
    ...
    public void testBasicPartitionedInsertsOnly() {
        ...
        // Act
        SnapshotDeltaLakeTable conversionAction = DeltaLakeToIcebergMigrationSparkIntegration
                .snapshotDeltaLakeKernelTable(spark, newTableIdentifier, sourceTableLocation);
        SnapshotDeltaLakeTable.Result result = conversionAction.execute();

        // Assert
        checkSnapshotIntegrity(
                sourceTableLocation, sourceTable, newTableIdentifier, result);
