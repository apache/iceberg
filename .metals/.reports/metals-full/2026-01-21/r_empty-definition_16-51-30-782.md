error id: file://<WORKSPACE>/core/src/main/java/org/apache/iceberg/rest/ErrorHandlers.java:_empty_/ServiceFailureException#
file://<WORKSPACE>/core/src/main/java/org/apache/iceberg/rest/ErrorHandlers.java
empty definition using pc, found symbol in pc: _empty_/ServiceFailureException#
  ...
  private static class DefaultErrorHandler extends ErrorHandler {
    ...
    public void accept(ErrorResponse error) {
      switch (error.code()) {
        ...
        case 500:
          throw new ServiceFailureExcepti@@on("Server error: %s: %s", error.type(), error.message());
        case 501:
          throw new UnsupportedOperationException(error.message());
        case 503:
