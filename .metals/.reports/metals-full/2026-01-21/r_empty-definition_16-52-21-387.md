error id: file://<WORKSPACE>/core/src/test/java/org/apache/iceberg/rest/RESTCatalogServlet.java:_empty_/RESTCatalogAdapter#
file://<WORKSPACE>/core/src/test/java/org/apache/iceberg/rest/RESTCatalogServlet.java
empty definition using pc, found symbol in pc: _empty_/RESTCatalogAdapter#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 2465
uri: file://<WORKSPACE>/core/src/test/java/org/apache/iceberg/rest/RESTCatalogServlet.java
text:
```scala
/*
...
public class RESTCatalogServlet extends HttpServlet {
  ...
  public RESTCatalogServlet(RESTCatalogAd@@apter restCatalogAdapter) {
