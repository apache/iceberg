error id: file://<WORKSPACE>/core/src/test/java/org/apache/iceberg/rest/TestErrorHandlers.java:org/apache/iceberg/rest/TestErrorHandlers#assertThatThrownBy#isInstanceOf#
file://<WORKSPACE>/core/src/test/java/org/apache/iceberg/rest/TestErrorHandlers.java
empty definition using pc, found symbol in pc: org/apache/iceberg/rest/TestErrorHandlers#assertThatThrownBy#isInstanceOf#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 2209
uri: file://<WORKSPACE>/core/src/test/java/org/apache/iceberg/rest/TestErrorHandlers.java
text:
```scala
/*
...
class TestErrorHandlers {
  ...
  public void testErrorHandlerWithCodeAndMessageOnly() {
    ...
    assertThatThrownBy(() -> ErrorHandlers.defaultErrorHandler().accept(error))
        .isInstanc@@eOf(RESTException.class)
