...
/**
 * An upsert job that generates 25 updates and 25 inserts in each partition.
 */
object UseCase1Upsert extends UseCaseBase {

  private final val LOG = LogManager.getLogger(UseCase1Upsert.getClass)
