...
/**
 * A MERGE job that generates 1% of updates and 25 inserts in each partition.
 */
object UseCase2Merge extends UseCaseBase {

  private final val LOG = LogManager.getLogger(UseCase2Merge.getClass)
  ...
  private final val MAINTENANCE_RESULTS = s"use_case_2_${MODE_SHORT}_maintenance_results"
