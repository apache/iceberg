...
public class TestVariantBuilderArray {
  ...
  public void testSimpleArrayJson() throws IOException {
    ...
    VariantArray arr = variant.value().asArray();
  ...
  public void testBuildArray() {
    ...
    VariantArray arr = variant.value().asArray();
    assertThat(arr.type()).isEqualTo(Variants.PhysicalType.ARRAY);
    assertThat(arr.numElements()).isEqualTo(20);
    assertThat(arr.get(0).asPrimitive().get()).isNull();
    assertThat(arr.get(1).asPrimitive().get()).isEqualTo(true);
    assertThat(arr.get(2).asPrimitive().get()).isEqualTo(false);
    assertThat(arr.get(3).asPrimitive().get()).isEqualTo((byte) 34);
    assertThat(arr.get(4).asPrimitive().get()).isEqualTo((short) 1234);
    assertThat(arr.get(5).asPrimitive().get()).isEqualTo(1234567890);
    assertThat(arr.get(6).asPrimitive().get()).isEqualTo(1234567890987654321L);
    assertThat(arr.get(7).asPrimitive().get()).isEqualTo(12.34);
    assertThat(arr.get(8).asPrimitive().get()).isEqualTo(new BigDecimal("123456.789"));
    assertThat(arr.get(9).asPrimitive().get()).isEqualTo(new BigDecimal("123456789.987654321"));
    assertThat(arr.get(10).asPrimitive().get())
        .isEqualTo(new BigDecimal("12345678901234567890.987654321"));
    assertThat(arr.get(11).asPrimitive().get())
        .isEqualTo(DateTimeUtil.daysFromDate(LocalDate.parse("2017-08-18")));
    assertThat(arr.get(12).asPrimitive().get())
        .isEqualTo(
            DateTimeUtil.microsFromTimestamptz(
                OffsetDateTime.parse("2017-08-18T14:21:01.919+00:00")));
    assertThat(arr.get(13).asPrimitive().get())
        .isEqualTo(
            DateTimeUtil.microsFromTimestamp(LocalDateTime.parse("2017-08-18T14:21:01.919")));
    assertThat(arr.get(14).asPrimitive().get()).isEqualTo(12.34f);
    assertThat(arr.get(15).asPrimitive().get()).isEqualTo(ByteBuffer.wrap("iceberg".getBytes()));
    assertThat(arr.get(16).asPrimitive().get())
        .isEqualTo("This test string is used to generate a primitive string type of variant");
    assertThat(arr.get(17).asPrimitive().get()).isEqualTo("iceberg");
    assertThat(arr.get(18).type()).isEqualTo(Variants.PhysicalType.ARRAY);

    assertThat(arr.get(19).type()).isEqualTo(Variants.PhysicalType.OBJECT);
  }
