...
public class TestUpdateNamespacePropertiesOperationParser {
  @Test
  void testToJson() {
    UpdateNamespacePropertiesOperation op = ImmutableUpdateNamespacePropertiesOperation.builder()
        .namespace(Namespace.of("a"))
        .updated(List.of("k1"))
        .removed(List.of("k2"))
        .build();
    String expected = "{\"operation-type\":\"update-namespace-properties\",\"namespace\":[\"a\"],\"updated\":[\"k1\"],\"removed\":[\"k2\"]}";
  ...
  void testToJsonWithOptionalProperties() {
    UpdateNamespacePropertiesOperation op = ImmutableUpdateNamespacePropertiesOperation.builder()
        ...
        .missing(List.of("k3"))
        .build();
    String expected = "{\"operation-type\":\"update-namespace-properties\",\"namespace\":[\"a\"],\"updated\":[\"k1\"],\"removed\":[\"k2\"],\"missing\":[\"k3\"]}";
    assertThat(UpdateNamespacePropertiesOperationParser.toJson(op)).isEqualTo(expected);
  }

  @Test
  void testFromJson() {
    String json = "{\"operation-type\":\"update-namespace-properties\",\"namespace\":[\"a\"],\"updated\":[\"k1\"],\"removed\":[\"k2\"]}";
    UpdateNamespacePropertiesOperation expected = ImmutableUpdateNamespacePropertiesOperation.builder()
        .namespace(Namespace.of("a"))
        .updated(List.of("k1"))
        .removed(List.of("k2"))
        .build();
  ...
  void testFromJsonWithMissingProperties() {
    String missingNamespace = "{\"operation-type\":\"update-namespace-properties\",\"updated\":[\"k1\"],\"removed\":[\"k2\"]}";
    assertThatThrownBy(() -> UpdateNamespacePropertiesOperationParser.fromJson(missingNamespace))
        .isInstanceOf(IllegalArgumentException.class);

    String missingUpdated = "{\"operation-type\":\"update-namespace-properties\",\"namespace\":[\"a\"],\"removed\":[\"k2\"]}";
    assertThatThrownBy(() -> UpdateNamespacePropertiesOperationParser.fromJson(missingUpdated))
        .isInstanceOf(IllegalArgumentException.class);

    String missingRemoved = "{\"operation-type\":\"update-namespace-properties\",\"namespace\":[\"a\"],\"updated\":[\"k1\"]}";
  ...
  void testFromJsonWithInvalidProperties() {
    String invalidNamespace = "{\"operation-type\":\"update-namespace-properties\",\"namespace\":\"a\",\"updated\":[\"k1\"],\"removed\":[\"k2\"]}";
    assertThatThrownBy(() -> UpdateNamespacePropertiesOperationParser.fromJson(invalidNamespace))
        .isInstanceOf(IllegalArgumentException.class);

    String invalidUpdated = "{\"operation-type\":\"update-namespace-properties\",\"namespace\":[\"a\"],\"updated\":\"not-array\",\"removed\":[\"k2\"]}";
    assertThatThrownBy(() -> UpdateNamespacePropertiesOperationParser.fromJson(invalidUpdated))
        .isInstanceOf(IllegalArgumentException.class);

    String invalidRemoved = "{\"operation-type\":\"update-namespace-properties\",\"namespace\":[\"a\"],\"updated\":[\"k1\"],\"removed\":123}";
    assertThatThrownBy(() -> UpdateNamespacePropertiesOperationParser.fromJson(invalidRemoved))
        .isInstanceOf(IllegalArgumentException.class);

    String invalidMissing = "{\"operation-type\":\"update-namespace-properties\",\"namespace\":[\"a\"],\"updated\":[\"k1\"],\"removed\":[\"k2\"],\"missing\":123}";
