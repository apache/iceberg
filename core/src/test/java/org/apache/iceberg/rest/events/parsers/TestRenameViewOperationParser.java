...
public class TestRenameViewOperationParser {
  @Test
  void testToJson() {
    RenameViewOperation op = ImmutableRenameViewOperation.builder()
        .viewUuid("uuid")
        .sourceIdentifier(TableIdentifier.of(Namespace.empty(), "s"))
        .destIdentifier(TableIdentifier.of(Namespace.of("a"), "d"))
        .build();
    String expected = "{\"operation-type\":\"rename-view\",\"view-uuid\":\"uuid\",\"source\":{\"namespace\":[],\"name\":\"s\"},\"destination\":{\"namespace\":[\"a\"],\"name\":\"d\"}}";
  ...
  @Test
  void testFromJson() {
    String json = "{\"operation-type\":\"rename-view\",\"view-uuid\":\"uuid\",\"source\":{\"namespace\":[],\"name\":\"s\"},\"destination\":{\"namespace\":[\"a\"],\"name\":\"d\"}}";
    RenameViewOperation expected = ImmutableRenameViewOperation.builder()
        .viewUuid("uuid")
        .sourceIdentifier(TableIdentifier.of(Namespace.empty(), "s"))
        .destIdentifier(TableIdentifier.of(Namespace.of("a"), "d"))
        .build();
  ...
  void testFromJsonWithMissingProperties() {
    String missingUuid = "{\"operation-type\":\"rename-view\",\"source\":{\"namespace\":[],\"name\":\"s\"},\"destination\":{\"namespace\":[\"a\"],\"name\":\"d\"}}";
    assertThatThrownBy(() -> RenameViewOperationParser.fromJson(missingUuid))
        .isInstanceOf(IllegalArgumentException.class);

    String missingSource = "{\"operation-type\":\"rename-view\",\"view-uuid\":\"uuid\",\"destination\":{\"namespace\":[\"a\"],\"name\":\"d\"}}";
    assertThatThrownBy(() -> RenameViewOperationParser.fromJson(missingSource))
        .isInstanceOf(IllegalArgumentException.class);

    String missingDest = "{\"operation-type\":\"rename-view\",\"view-uuid\":\"uuid\",\"source\":{\"namespace\":[],\"name\":\"s\"}}";
  ...
  void testFromJsonWithInvalidProperties() {
    String invalidUuid = "{\"operation-type\":\"rename-view\",\"view-uuid\":123,\"source\":{\"namespace\":[],\"name\":\"s\"},\"destination\":{\"namespace\":[\"a\"],\"name\":\"d\"}}";
    assertThatThrownBy(() -> RenameViewOperationParser.fromJson(invalidUuid))
        .isInstanceOf(IllegalArgumentException.class);

    String invalidSource = "{\"operation-type\":\"rename-view\",\"view-uuid\":\"uuid\",\"source\":\"not-obj\",\"destination\":{\"namespace\":[\"a\"],\"name\":\"d\"}}";
    assertThatThrownBy(() -> RenameViewOperationParser.fromJson(invalidSource))
        .isInstanceOf(IllegalArgumentException.class);

    String invalidDest = "{\"operation-type\":\"rename-view\",\"view-uuid\":\"uuid\",\"source\":{\"namespace\":[],\"name\":\"s\"},\"destination\":123}";
