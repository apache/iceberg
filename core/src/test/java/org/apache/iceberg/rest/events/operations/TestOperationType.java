...
public class TestOperationType {
  @Test
  void testFromType() {
    assertThat(OperationType.fromType("create-table")).isEqualTo(OperationType.CREATE_TABLE);

    assertThatThrownBy(() -> OperationType.fromType(null))
        .isInstanceOf(NullPointerException.class)
        .hasMessage("Invalid OperationType: null");

    assertThatThrownBy(() -> OperationType.fromType("unknown"))
