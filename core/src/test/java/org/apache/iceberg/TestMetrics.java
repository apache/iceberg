...
public abstract class TestMetrics {
  ...
  private static final Schema SIMPLE_SCHEMA =
      new Schema(
          ...
          required(10, "timestampColAboveEpoch", TimestampType.microsWithoutZone()),
          required(11, "timestampnsColAboveEpoch", TimestampType.nanosWithoutZone()),
          required(12, "fixedCol", FixedType.ofLength(4)),
          required(13, "binaryCol", BinaryType.get()),
          required(14, "timestampColBelowEpoch", TimestampType.microsWithoutZone()),
          required(15, "timestampnsColBelowEpoch", TimestampType.nanosWithoutZone()));
  ...
  public void testMetricsForTopLevelFields() throws IOException {
    ...
    firstRecord.setField(
        "timestampnsColBelowEpoch", DateTimeUtil.timestampFromNanos(-1_900_300_000L));
    ...
    if (fileFormat() == FileFormat.ORC) {
      ...
      assertBounds(14, TimestampType.microsWithoutZone(), -1_900_300L, -7_000L, metrics);
      assertBounds(15, TimestampType.nanosWithoutZone(), -1_900_300_000L, -7_000_000L, metrics);
    }
  }
