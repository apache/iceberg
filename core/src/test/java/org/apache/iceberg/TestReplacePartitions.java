...
public class TestReplacePartitions extends TestBase {
  ...
  public void testReplaceAllVoidUnpartitionedTable() throws IOException {
    Table tableVoid =
            TestTables.create(
                    tableDir, "allvoidUnpartitioned", SCHEMA, SPEC_ALL_VOID, formatVersion);
    ...
    ReplacePartitions replacePartitions = tableVoid.newReplacePartitions().addFile(FILE_ALL_VOID_UNPARTITIONED_B);
