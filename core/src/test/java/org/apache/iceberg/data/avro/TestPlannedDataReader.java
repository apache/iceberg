...
public class TestPlannedDataReader {
  ...
  public void timestampDataReader() throws IOException {
    ...
    Record result = readRecords(reader, avroSchema, Collections.singletonList(avroRecord)).get(0);
    ...
    Record preEpochResult =
        readRecords(reader, avroSchema, Collections.singletonList(preEpochRecord)).get(0);
