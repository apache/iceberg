...
public class TestCommitReporting extends TestBase {
  ...
  public void addAndDeleteDeleteFiles() {
    ...
    long totalDeleteContentSize =
        ContentFileUtil.contentSizeInBytes(fileADeletes())
            + ContentFileUtil.contentSizeInBytes(fileBDeletes())
            + ContentFileUtil.contentSizeInBytes(FILE_C2_DELETES);
