...
public class TestNameMappingWithAvroSchema {
  ...
  public void testNameMappingWithAvroSchema() {
    ...
    MappedFields expected =
        MappedFields.of(
            ...
            MappedField.of(
                2,
                "location",
                MappedFields.of(MappedField.of(8, "lat"), MappedField.of(9, "long"))),
            MappedField.of(3, "friends", MappedFields.of(MappedField.of(10, "element"))),
            ...
            MappedField.of(
                ...
                MappedFields.of(
                    ...
                    MappedField.of(
                        21,
                        "innerRecord2",
                        MappedFields.of(MappedField.of(13, "lat"), MappedField.of(14, "long"))),
                    MappedField.of(
                        22,
                        "innerRecord3",
                        MappedFields.of(
    ...
    Assert.assertEquals(
        expected,
        nameMappingWithAvroSchema.visit(icebergSchema, schema, nameMappingWithAvroSchema));
  }
}
