...
public class TestMetadataUpdateParser {
  ...
  private static void assertEqualsSetPartitionStatistics(
    ...
    Assert.assertEquals(
        "Partition statistics max data sequence number should be equal",
        expected.partitionStatisticsFile().maxDataSequenceNumber(),
        actual.partitionStatisticsFile().maxDataSequenceNumber());
  }
