...
public class TestStrictStatsEvaluator {
  private static final Schema SCHEMA =
      new Schema(
          ...
          optional(
              ...
              "struct",
              Types.StructType.of(
                  Types.NestedField.optional(16, "nested_col_no_stats", IntegerType.get()),
                  Types.NestedField.optional(17, "nested_col_with_stats", IntegerType.get()))));
          ...
          BaseContentStats.builder()
              ...
              .withFieldStats(
                  BaseFieldStats.builder()
                      ...
                      .build())
              .withFieldStats(
                  BaseFieldStats.builder().fieldId(8).valueCount(50L).nanValueCount(50L).build())
              .withFieldStats(
                  BaseFieldStats.builder().fieldId(9).valueCount(50L).nanValueCount(10L).build())
              .withFieldStats(
                  BaseFieldStats.builder()
                      .fieldId(10)
                      .valueCount(50L)
  ...
  private static final DataFile FILE_2 =
      new TestDataFile(
          ...
          BaseContentStats.builder()
              ...
              .withFieldStats(
                  BaseFieldStats.builder().fieldId(6).valueCount(50L).nullValueCount(0L).build())
              .withFieldStats(BaseFieldStats.builder().fieldId(8).valueCount(50L).build())
              .build());
