...
public class TestV4SnapshotProducer {
  ...
  public void testAppendV4() throws IOException {
    ...
    assertThat(rootEntry.formatVersion())
        ...
        .isEqualTo(ContentEntryAdapters.V4_FORMAT_VERSION);
  ...
  public void testTwoAppendsV4() throws IOException {
    ...
    assertThat(existingEntry.formatVersion()).isEqualTo(ContentEntryAdapters.V4_FORMAT_VERSION);
    assertThat(addedEntry.formatVersion()).isEqualTo(ContentEntryAdapters.V4_FORMAT_VERSION);
  ...
  public void testDeleteFileV4() throws IOException {
    ...
    for (TrackedFileStruct row : rootRows) {
      ...
      assertThat(row.formatVersion()).isEqualTo(ContentEntryAdapters.V4_FORMAT_VERSION);
