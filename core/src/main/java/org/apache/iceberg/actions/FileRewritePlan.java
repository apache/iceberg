 ...
 * generated groups, like the total number of the groups and the groups per partition. The groups in
 * the plan also contain some calculated values required by the {@link FileRewriteRunner}s where the
 * values are based on the input data and the planning parameters.
 *
