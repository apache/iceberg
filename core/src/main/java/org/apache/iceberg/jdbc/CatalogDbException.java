...
public class CatalogDbException extends Exception {
  ...
  public static CatalogDbException fromSqlException(String queryName, SQLException sqlException) {
    ...
    if (sqlException instanceof SQLIntegrityConstraintViolationException) {
      return new CatalogDbException(queryName + " violated key constraint.", sqlException, Code.ALREADY_EXISTS);
      ...
      return new CatalogDbException(queryName + " failed with transient db exception.", sqlException, Code.TRANSIENT);
    }
    return new CatalogDbException(queryName + " failed with error from database.", sqlException, Code.DATABASE_ERROR);
  }

  public static CatalogDbException wrapInterruption(String queryName, InterruptedException interruption) {
    return new CatalogDbException("Interrupted during " + queryName, interruption, Code.INTERRUPTED);
  }
