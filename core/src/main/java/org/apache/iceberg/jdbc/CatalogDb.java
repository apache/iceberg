...
public interface CatalogDb extends AutoCloseable {
  ...
  void updateTable(String namespaceName, String tableName, String oldPointer, String newPointer)
      throws CatalogDbException;

  void renameTable(String sourceNamespace, String sourceTable, String newNamespace, String newTable)
      throws CatalogDbException;

  void insertTable(String tableCatalogName, String namespaceName, String tableName, String tablePointer)
      throws CatalogDbException;

  /**
   * Get current table pointer. In order to be useful in a check-and-create transaction, this will
   * not throw if table doesn't exist.
   *
