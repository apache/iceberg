...
class ColumnFileStruct extends SupportsIndexProjection implements ColumnFile, Serializable {
  ...
  public boolean equals(Object other) {
    if (this == other) {
      return true;
    } else if (!(other instanceof ColumnFileStruct)) {
      return false;
    }

    ColumnFileStruct that = (ColumnFileStruct) other;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(Arrays.hashCode(fieldIds), location, fileSizeInBytes);
  }
