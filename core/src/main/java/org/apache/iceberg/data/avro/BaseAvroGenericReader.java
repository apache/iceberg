...
public class BaseAvroGenericReader<T> implements DatumReader<T> {
  ...
  protected BaseAvroGenericReader(org.apache.iceberg.Schema expectedSchema, Schema readSchema,
