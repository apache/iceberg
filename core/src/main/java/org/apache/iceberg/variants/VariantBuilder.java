...
public class VariantBuilder extends VariantBuilderBase {
  ...
  public VariantPrimitiveBuilder createPrimitive() {
    VariantPrimitiveBuilder primitiveBuilder = new VariantPrimitiveBuilder(buffer, dict);
  ...
  private void writeObject(JsonParser parser) throws IOException {
    ...
    while (parser.nextToken() != JsonToken.END_OBJECT) {
      ...
      int id = dict.add(key);
      fields.add(new VariantBuilderBase.FieldEntry(key, id, buffer.pos - startPos));
      buildJson(parser);
    }
