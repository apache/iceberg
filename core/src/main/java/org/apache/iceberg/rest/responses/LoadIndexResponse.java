...
/** A REST response that is used when an index is successfully loaded. */
public class LoadIndexResponse implements RESTResponse {
  ...
  private LoadIndexResponse(
      String metadataLocation, IndexMetadata metadata, Map<String, String> config) {
  ...
  public static class Builder {
    ...
    public Builder withMetadata(IndexMetadata indexMetadata) {
    ...
    public LoadIndexResponse build() {
      Preconditions.checkNotNull(metadata, "Invalid metadata: null");
      return new LoadIndexResponse(metadataLocation, metadata, config);
    }
  }
}
