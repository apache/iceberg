...
public class RESTSessionCatalog extends BaseViewSessionCatalog
  ...
  public Table loadTable(SessionContext context, TableIdentifier identifier) {
    ...
    RESTTable restTable = tableSupportsRemoteScanPlanning(ops, finalIdentifier, session);
    if (restTable != null) {
      return restTable;
    }
  ...
  private RESTTable tableSupportsRemoteScanPlanning(
      TableOperations ops, TableIdentifier finalIdentifier, AuthSession session) {
  ...
  public Table registerTable(
    ...
    RESTTable restTable = tableSupportsRemoteScanPlanning(ops, ident, session);
    if (restTable != null) {
      return restTable;
    }
