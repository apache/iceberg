...
public interface RESTClient extends Closeable {
  ...
  <T> T put(String path, Object body, Class<T> responseType, Consumer<ErrorResponse> errorHandler);
  ...
  <T> T head(String path, Class<T> responseType, Consumer<ErrorResponse> errorHandler);
  <T> T head(String path);
}
