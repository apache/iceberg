...
public class CreateNamespaceResponseParser {

  private CreateNamespaceResponseParser() {}

  public static String toJson(CreateNamespaceResponse response) {
    return toJson(response, false);
  }

  public static String toJson(CreateNamespaceResponse response, boolean pretty) {
    return JsonUtil.generate(gen -> toJson(response, gen), pretty);
  }

  public static void toJson(CreateNamespaceResponse response, JsonGenerator gen)
      throws IOException {
  ...
  public static CreateNamespaceResponse fromJson(String json) {
    return JsonUtil.parse(json, CreateNamespaceResponseParser::fromJson);
  }

  public static CreateNamespaceResponse fromJson(JsonNode json) {
    ...
    return ImmutableCreateNamespaceResponse.newBuilder()
