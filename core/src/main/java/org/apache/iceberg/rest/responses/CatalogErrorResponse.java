...
/** Standard response body for catalog API errors */
public class CatalogErrorResponse implements ErrorResponse {
  ...
  private CatalogErrorResponse(String message, String type, int code, List<String> stack) {
  ...
  public static class Builder {
    ...
    public CatalogErrorResponse build() {
      Preconditions.checkArgument(code != null, "Invalid response, missing field: code");
      return new CatalogErrorResponse(message, type, code, stack);
    }
  }
}
