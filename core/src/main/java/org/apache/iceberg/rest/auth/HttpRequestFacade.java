...
public interface HttpRequestFacade {
  ...
  /**
   * Adds a header to this request. Existing headers with the same name will not be overwritten.
   *
  ...
  /**
   * Sets a header to this request. Existing headers with the same name will be overwritten.
   *
   * @param name the name of the header.
   * @param value the value of the header.
   */
