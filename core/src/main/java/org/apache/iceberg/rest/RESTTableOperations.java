...
class RESTTableOperations implements TableOperations {
  ...
  RESTTableOperations(
      RESTClient client, String path, AuthSession authSession, FileIO io, TableMetadata current) {
    this(client, path, authSession, io, UpdateType.SIMPLE, Lists.newArrayList(), current);
  }
