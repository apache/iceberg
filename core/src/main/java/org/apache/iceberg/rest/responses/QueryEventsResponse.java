...
/** Response containing a page of catalog change events. */
@Value.Immutable
public interface QueryEventsResponse extends RESTResponse {
  ...
  /** The list of events in this response page. */
  List<Event> events();

  @Override
  default void validate() {
    Preconditions.checkArgument(nextPageToken() != null, "Invalid next-page-token: null");
  }
}
