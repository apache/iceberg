...
/** Enum representing the type of operation performed on a {@link org.apache.iceberg.catalog.CatalogObject} */
    ...
    public class CustomOperationType {
        ...
        public CustomOperationType(String type) {
            if(!PATTERN.matcher(type).matches()) {
                throw new IllegalArgumentException("Custom operation type must start with 'x-' followed by an implementation-specific identifier.");
            }
