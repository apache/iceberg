...
public class CachingCatalog implements Catalog {
  ...
  public static Catalog wrap(
      Catalog catalog, long expirationIntervalMillis, CacheExpirationPolicy cacheExpirationPolicy) {
    return wrap(catalog, true, expirationIntervalMillis, cacheExpirationPolicy);
  }
   ...
   *     Ticker, CacheExpirationPolicy)} instead.
   */
  @Deprecated
  @VisibleForTesting
  @SuppressWarnings("checkstyle:VisibilityModifier")
