...
public class CachingCatalog implements Catalog {
   ...
   *     org.apache.iceberg.CachingCatalog#CachingCatalog(org.apache.iceberg.catalog.Catalog,
   *     boolean, long, com.github.benmanes.caffeine.cache.Ticker,
   *     org.apache.iceberg.CatalogProperties.CacheExpirationPolicy) and pruneColumns(Schema, Set)
   *     instead.
   */
  @Deprecated
  @VisibleForTesting
  ...
  protected CachingCatalog(
    ...
    this(
        ...
        expirationIntervalMillis,
        ticker,
        CacheExpirationPolicy.EXPIRE_AFTER_WRITE);
  }
