...
public class Partitioning {
  ...
  /**
   * Builds a unified partition type considering the provided schema and specs.
   *
   * <p>Behaves identically to {@link #partitionType(Table)} but accepts a schema and specs
   * collection directly, for callers that do not have a {@link Table} reference (e.g., writers
   * computing the union partition type from {@link TableMetadata#specsById()}).
   *
