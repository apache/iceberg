...
class ViewMetadataReadTask implements DataTask {
  ...
  static <T> DataTask of(
    ...
    return new ViewMetadataReadTask(
        location,
        tableSchema,
        projectedSchema,
  ...
  private ViewMetadataReadTask(
      String location, Schema tableSchema, Schema projectedSchema, StructLike[] rows) {
