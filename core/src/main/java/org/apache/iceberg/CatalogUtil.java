...
public class CatalogUtil {
  ...
  public static final String ICEBERG_CATALOG_TYPE_SNOWFLAKE = "snowflake";
  ...
  public static final String ICEBERG_CATALOG_SNOWFLAKE = "org.apache.iceberg.snowflake.SnowflakeCatalog";
    ...
    if (catalogImpl == null) {
      ...
      switch (catalogType.toLowerCase(Locale.ENGLISH)) {
        ...
        case ICEBERG_CATALOG_TYPE_NESSIE:
          ...
          break;
        case ICEBERG_CATALOG_TYPE_SNOWFLAKE:
          catalogImpl = ICEBERG_CATALOG_SNOWFLAKE;
          break;
