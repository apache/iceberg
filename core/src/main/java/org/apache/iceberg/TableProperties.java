...
public class TableProperties {
  ...
  public static final String ORC_VECTOR_ROW_BATCH_SIZE = "write.orc.vectorized-row-batch-size";
  public static final String DELETE_ORC_VECTOR_ROW_BATCH_SIZE = "write.delete.orc.vectorized-row-batch-size";
  public static final int ORC_VECTOR_ROW_BATCH_SIZE_DEFAULT = 1024;
