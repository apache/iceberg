...
public class TableProperties {
  ...
  /**
   * Controls whether to use ParquetFileMerger for row-group level merging during compaction. When
   * enabled, Parquet files are merged at the row-group level without full deserialization,
