...
public class PartitionStatisticsFileParser {
  ...
  private static final String MAX_DATA_SEQUENCE_NUMBER = "max-data-sequence-number";
  ...
  public static void toJson(PartitionStatisticsFile statisticsFile, JsonGenerator generator)
    ...
    generator.writeNumberField(MAX_DATA_SEQUENCE_NUMBER, statisticsFile.maxDataSequenceNumber());
  ...
  static PartitionStatisticsFile fromJson(JsonNode node) {
    ...
    long maxDataSequenceNumber = JsonUtil.getLong(MAX_DATA_SEQUENCE_NUMBER, node);
    return ImmutableGenericPartitionStatisticsFile.builder()
        .snapshotId(snapshotId)
        .path(path)
        .maxDataSequenceNumber(maxDataSequenceNumber)
        .build();
  }
}
