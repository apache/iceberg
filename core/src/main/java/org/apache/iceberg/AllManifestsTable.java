...
public class AllManifestsTable extends BaseMetadataTable {
  ...
  static final Schema MANIFEST_FILE_SCHEMA =
      new Schema(
          ...
          Types.NestedField.optional(19, "added_rows_count", Types.LongType.get()),
          Types.NestedField.optional(6, "existing_data_files_count", Types.IntegerType.get()),
          Types.NestedField.optional(20, "existing_rows_count", Types.LongType.get()),
          ...
          Types.NestedField.required(21, "deleted_rows_count", Types.LongType.get()),
