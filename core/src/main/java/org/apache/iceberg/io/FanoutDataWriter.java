 ...
 */
public class FanoutDataWriter<T> extends FanoutFileWriter<T, DataWriteResult> {
  ...
  public FanoutDataWriter(WriterFactory<T> writerFactory, OutputFileFactory fileFactory,
