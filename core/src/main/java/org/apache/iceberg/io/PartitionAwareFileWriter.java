 ...
 * limited to writing to a single spec/partition. Implementations may under the hood use other
 * {@link FileWriter}s for writing to a single spec/partition.
 */
public interface PartitionAwareFileWriter<T, R> extends Closeable {
