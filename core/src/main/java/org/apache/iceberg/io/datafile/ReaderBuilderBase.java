...
/**
 * Base implementation for the {@link ReaderBuilder} which handles the common attributes for the
 * builders.
 *
 * @param <T> the type of the builder which is needed so method chaining is available for the
 *     builder
 */
public abstract class ReaderBuilderBase<T extends ReaderBuilderBase<T>>
