 ...
 *     builder
 */
public abstract class FileFormatWriterBuilderBase<T extends FileFormatWriterBuilderBase<T>>
    implements FileFormatWriterBuilder<T> {
  private final FileFormatAppenderBuilder<?> appenderBuilder;
  ...
  public FileFormatWriterBuilderBase(
  ...
  protected FileFormatAppenderBuilder<?> appenderBuilder() {
