...
public class PartitionData
  ...
  static Schema partitionDataSchema(Types.StructType partitionType) {
    return AvroSchemaUtil.convert(partitionType, PartitionData.class.getName(), true);
  }
  ...
  PartitionData(Schema schema) {
    this.partitionType = AvroSchemaUtil.convert(schema, true).asNestedType().asStructType();
