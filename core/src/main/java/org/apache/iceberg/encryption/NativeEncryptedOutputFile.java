...
class NativeEncryptedOutputFile implements EncryptedOutputFile {
  ...
  NativeEncryptedOutputFile(OutputFile rawOutput, EncryptionKeyMetadata keyMetadata,
                            NativeFileEncryptParameters nativeEncryptionParameteres) {
    this.rawOutput = rawOutput;
    this.nativeEncryptionParameteres = nativeEncryptionParameteres;
  ...
  @Override
  public NativeFileEncryptParameters nativeEncryptionParameters() {
    return nativeEncryptionParameteres;
  }
