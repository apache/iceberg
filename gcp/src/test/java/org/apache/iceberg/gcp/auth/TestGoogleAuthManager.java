...
public class TestGoogleAuthManager {
  ...
  public void beforeEach() throws IOException {
    ...
    credentialKey = "{\"type\": \"service_account\"}";
    Files.write(credentialFile.toPath(), credentialKey.getBytes(StandardCharsets.UTF_8));
  }
  ...
  public void throwsIllegalArgumentExceptionOnMultipleCredentials() {
    ...
    assertThatThrownBy(() -> authManager.catalogSession(restClient, properties))
        ...
        .hasMessage("Cannot specify both gcp.auth.credentials-path and gcp.auth.credentials-key");
  }
